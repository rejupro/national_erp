...
$menuh='Report';
$phead='report';
$page='Project Sales List';
$ractive='A';
$print='print';
$dtnow = date("Y-m-d h:i:s", time());
$today = strftime("%Y-%m-%d", time());
$oavno='REP'.date("dmy", strtotime($today)).'SALR';
?>
                  ...
                  <div class="printableArea">
                     ...
                     <div class="wrapper" style="background: none;">
                        <div id="wrap_invoice" class="page A4 landscape">
                           ...
                           <center>
                              <h3 class="page-title">INVOICE WISE PURCHASE</h3>
                           </center>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/main/admin/report/sales_ListReport.blade.php ENDPATH**/ ?>