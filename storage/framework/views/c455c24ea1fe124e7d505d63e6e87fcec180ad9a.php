                                    ...
                                    <table class="table table-bordered table-striped" style="margin-bottom: 0;">    
                                        <tbody id="itemdata">
                                            ...
                                            <tr>
                                                ...
                                                <td width="60px">
                                                    <input type="text" min="1" onchange="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" class="form-control quantity" id="quantity<?php echo e($i); ?>" name="quantity[]" value="0" size="2" style="height: 24px;">
                                                </td>
                                                <td width="60px">
                                                    ...
                                                    <div class="accordian-body" id="pitem<?php echo e($i); ?>">
                                                        <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disp" id="pur_discount<?php echo e($i); ?>" value="0" name="pur_discount[]" onchange="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" size="2" style="height: 24px;">
                                                                    </td>

                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disf" id="pur_discount_amount<?php echo e($i); ?>" name="pur_discount_amount[]" value="0" onchange="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" size="2" style="height: 24px;">
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="0" id="sal_discount<?php echo e($i); ?>" class="form-control sdisp"value="0" name="sal_discount[]" onchange="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" size="2" style="height: 24px;">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="0" id="sal_discount_amount<?php echo e($i); ?>" class="form-control sdisf" name="sal_discount_amount[]" onchange="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" value="0" size="2" style="height: 24px;">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            <tfoot>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/rmc_construction/final_v5/rmc_final/resources/views/main/admin/purchase/purchase_create.blade.php ENDPATH**/ ?>