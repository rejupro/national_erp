...
<section class="content-header">
   <h1><?php if( Auth::User()->language == 1 ): ?> ব্রাঞ্চ ট্রান্সফার ক্রিয়েট <?php else: ?> Branch Transfer Create <?php endif; ?></h1>
   <ol class="breadcrumb">
        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> ব্রাঞ্চ ট্রান্সফার ক্রিয়েট <?php else: ?> Branch Transfer Create <?php endif; ?></a></li>
   </ol>
</section>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-solid">
                    ...
                    <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> এড নিউ ব্রাঞ্চ ট্রান্সফার <?php else: ?> Add New Branch Transfer <?php endif; ?></h3>
                    </div>
                        <?php if($errors->any()): ?>
                        ...
                        <?php endif; ?>
                    <div class="box-body">
                        <form action="<?php echo e(route('branch-transfer-stock-store')); ?>" onsubmit="return validate()" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                         <div class="form-group" >
                                             <label><?php if( Auth::User()->language == 1 ): ?> ব্রাঞ্চের নাম (হতে) <?php else: ?> Branch Name(From) <?php endif; ?></label>
                                    ...
                                    <div class="row">
                                         <div class="form-group" >
                                             <label><?php if( Auth::User()->language == 1 ): ?> ব্রাঞ্চের নাম (কাছে) <?php else: ?> Branch Name(To) <?php endif; ?></label>
                                             <div class="input-group">
                                                 <span class="input-group-addon">TBN</span>
                                                 <select class="form-control select2" name="branch_id_to" id="branch_id_to">
                                                 <option value="">-Select-</option> 
                                                 <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                            ...
                            <div class="row"style="margin-top: 15px" >
                                ...
                                <input type="submit" name="save_user" id="submit" class="btn btn-flat bg-purple btn-sm " value="<?php if( Auth::User()->language == 1 ): ?> সেভ <?php else: ?> Save <?php endif; ?>"/> <a href="<?php echo e(route('branch-transfer-stock-list')); ?>" class="btn btn-flat bg-gray  "><?php if( Auth::User()->language == 1 ): ?> ক্লোজ <?php else: ?> Close <?php endif; ?></a>
                                </div> 
                            </div>     
                        </form>    
                    </div>
...
<script type="text/javascript">
    function find_product_branch() {
        ...
        alert(branch_id_from);
            ...
            var url = '<?php echo e(route("find_product_for_transfer_branch", ":slug")); ?>';
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/inventory/branch_tr_create.blade.php ENDPATH**/ ?>