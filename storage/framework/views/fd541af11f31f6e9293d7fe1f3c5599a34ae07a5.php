      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="col-md-1 text-right">
                <a href='<?php echo e(url()->previous()); ?>'><button class="btn btn-flat bg-red" id="closepop"><span><i class="fa fa-times"></i></span></button></a>
            </div>
         </div>
      </div>
   </div>
               ...
               <div class="col-md-3">
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="<?php echo e(route('requisition-view-route',['id'=>$lists->code])); ?>">
                           <?php if($lists->code==$requisition->code): ?>
                           <li class="invpiv active" >
                           <?php else: ?>
                           <li class="invpiv" >
                           <?php endif; ?>
                              <p><strong class="pino"><?php echo e($lists->code); ?></strong><br><br><strong><?php echo e($lists->created_at); ?></strong></p>
                     ...
                     <div class="printableArea">
                        ...
                        <div class="wrapper" style="width: 407.726px; height: 574.703px; overflow: hidden;">
                           <div id="wrap_invoice" class="page A4 portrait" style="transform: scale(0.51); transform-origin: 10px 0px 0px;">
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,<?php echo e(DNS1D::getBarcodePNG($requisition->code, 'C39')); ?>" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Requisition N°:</strong> <?php echo e($requisition->code); ?>
                              ...
                              <center>
                                 <h3 class="page-title">REQUISITION INVOICE</h3>
                              </center>
                                 ...
                                 <div class="page_split">
                                    ...
                                    <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Vendor</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;"><?php echo e($requisition->staff->name); ?></span><br><strong>Contact:</strong> <?php echo e($requisition->cnumber); ?><br><strong>Email ID:</strong><?php echo e($requisition->cemail); ?></p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Address</h4>
                                          <?php echo e($requisition->address); ?>
                                    ...
                                    <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Project Name</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;"><?php echo e($requisition->project->project_id); ?></span></p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Status</h4>
                                          <p><strong><?php echo e($requisition->status); ?></strong></p>
                                       </div>
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                       <thead>
                                        <tr>
                                            ...
                                            <th style="width:52.5% !important;">Requisition Item</th>
                                            <th style="width:10% !important;">Net Price</th>
                                            <th style="width:10% !important;">Quantity</th>
                                            <th style="width:7.5% !important;">Price</th>
                                         </tr>
                                      </thead>
                                      <tbody>
                                          <?php
                                         ...
                                         <tr>
                                            ...
                                            <td class="text-md-center"><?php echo e($data->requisition_item); ?></td>
                                            <td class="text-md-right"><?php echo number_format("$data->nprice",2) ?></td>
                                            <td class="text-md-center"><?php echo e($data->qty); ?></td>
                                            <td class="text-md-center"><?php echo number_format("$data->price",2) ?></td>
                                         </tr>
                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         <tr>
                                            <td colspan="2"></td>
                                            <td colspan="2" class="text-md-right font-weight-bold"> Total</td>
                                            <td colspan="2" class="text-md-right font-weight-bold text-nowrap"><?php echo number_format("$requisition->grand_total",2) ?></td>
                                         </tr>
                                    ...
                                    <p>
                                       ...
                                       <span style="text-transform: uppercase;">
                                        <?php echo e(NumConvert::word($requisition->grand_total)); ?> 
                                       <b>Taka</b> Only.</span>
                                    </p>
                                 </div>
                              </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/rmc_construction/final_v5/rmc_final/resources/views/main/admin/requisition/requisition_view.blade.php ENDPATH**/ ?>