...
<section class="content-header">
   <h1><?php if( Auth::User()->language == 1 ): ?> লেদজার লিস্ট <?php else: ?> Ledger List <?php endif; ?></h1>
   <ol class="breadcrumb">
      <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
      <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> লেদজার লিস্ট <?php else: ?> Ledger List <?php endif; ?></a></li>
   </ol>
</section>
<!-- Main content -->
      ...
      <div class="col-md-8">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> লেদজার লিস্ট <?php else: ?> Ledger List <?php endif; ?></h3>
            </div>
            <div class="box-body">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td nowrap="" class="text-center">
                              ...
                              <a class="btn btn-flat bg-purple" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo e(route('ledger-destroy-route',['id' => $ledger->id])); ?>" ><i class="fa fa-trash"></i></a>
                           </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </tbody>
               ...
               <div class="row"style="margin-top: 15px" >
                  <div class="col-md-12 table-responsive">
                     ...
                     <div class="col-md-4 text-right" >
                        <a href="<?php echo e(route('ledger-create-route')); ?>" class="btn btn-flat bg-purple"><?php if( Auth::User()->language == 1 ): ?> এড লেদজার <?php else: ?> Add Ledger <?php endif; ?></a>
                     </div>
                  </div>
               </div>
            </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/accounts/ledgerlist.blade.php ENDPATH**/ ?>