...
<section class="content-header">
   <h1><?php if( Auth::User()->language == 1 ): ?> ওয়ারহাউজ ট্রান্সফার <?php else: ?> Warehouse Transfer <?php endif; ?></h1>
   <ol class="breadcrumb">
        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> ওয়ারহাউজ ট্রান্সফার <?php else: ?> Warehouse Transfer <?php endif; ?></a></li>
   </ol>
</section>
...
<section class="content">
    ...
    <td><?php echo e($data->warehouse_name); ?></td>
    <td><?php echo e($data->warehouses_name); ?></td>
    ...
    <a href="<?php echo e(route('warehouse-transfer-stock-create')); ?>" class="btn btn-flat bg-purple"><?php if( Auth::User()->language == 1 ): ?> ক্রিয়েট ট্রান্সফার <?php else: ?> Create Transfer <?php endif; ?></a>
    </div>
    </div>
    </div>
    </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/inventory/warehouse_tr_list.blade.php ENDPATH**/ ?>