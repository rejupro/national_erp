...
?>
    ...
    <section class="content">
        ...
        <a href="<?php echo e(route('sales-create-page')); ?>" class="btn btn-flat bg-purple">Create Sales</a>
        </div>
        </div>
        </div>
        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/main/admin/sales/sales_list.blade.php ENDPATH**/ ?>