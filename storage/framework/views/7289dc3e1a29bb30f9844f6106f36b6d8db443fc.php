...
$oavno='REP'.date("dmy", strtotime($today)).'SALO';
?>
...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li class=""><a href="#">Sales Overview</a></li>
   </ol>
 </section>
<!-- Main content -->
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/main/admin/report/salesOverview.blade.php ENDPATH**/ ?>