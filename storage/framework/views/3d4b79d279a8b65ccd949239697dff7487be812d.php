    ...
    <section class="content">
        ...
        <tr>
            ...
            <td nowrap="">
                ...
                <a class="btn btn-flat bg-purple details-invoice" href="<?php echo e(route('purchase-delete-page',$data->pur_invoice)); ?>"><i class="fa fa-trash cat-child"></i></a>
                </td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
        ...
        <a href="<?php echo e(route('purchase-create-page')); ?>" class="btn btn-flat bg-purple">Create Purchase</a>
        </div>
        </div>
        </div>
        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/main/admin/purchase/purchase_list.blade.php ENDPATH**/ ?>