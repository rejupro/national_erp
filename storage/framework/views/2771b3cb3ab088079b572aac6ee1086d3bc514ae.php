    ...
    <section class="content-header">
        <h1>Bank Edit</h1>
            <ol class="breadcrumb">
                ...
                <li class=""><a href="<?php echo e(route('create-bank-page')); ?>">Bank Edit</a></li>
            </ol>
    </section>
    <!-- Main content -->
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/rmc_construction/final_v5/rmc_final/resources/views/main/admin/bank/bank_edit.blade.php ENDPATH**/ ?>