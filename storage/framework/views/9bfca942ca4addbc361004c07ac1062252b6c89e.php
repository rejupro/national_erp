                            ...
                            <ul class="smenu">
                                ...
                                <li class="smenu-treeview"><a href="#" class="smenu-title"><i class="fa fa-exchange" aria-hidden="true"></i>Project Report</a>
                                    <ul class="smenu-treeview-menu">
                                        ...
                                        <li><a href="<?php echo e(route('project-contractorlist-report')); ?>" ><i class="fa fa-caret-right"></i>Contructor List</a></li>
                                        <li><a href="<?php echo e(route('project-contractorbalance-report')); ?>" ><i class="fa fa-caret-right"></i>Contructor Balance</a></li>
                                        <li><a href="<?php echo e(route('project-contractorstate-report')); ?>" ><i class="fa fa-caret-right"></i>Contructor Statement</a></li>
                            ...
                            <ul class="smenu">
                                ...
                                <li class="smenu-treeview">
                                    ...
                                    <ul class="smenu-treeview-menu">
                                        ...
                                        <li><a href="<?php echo e(route('vouoverview-report')); ?>" ><i class="fa fa-caret-right"></i> Overview</a></li>    
                                    </ul>
                                </li>
                            </ul>
                        </div>
