...
?>
    ...
    <script>
                ...
                success:function(response){
                    ...
                    $.each(response.data, function(key, value){
                        ...
                        allData += `<tr>
                                        ...
                                        <td>${ i++ }</td>
                                        <td>
                                            <input type="hidden" value="${value.product_id}" name="material_id" id="material_id" >
                                            ${value.product_name}
                                        </td>
                                        <td>
                                        ...
                                        <td><input type="text" class="form-control" id="stock_amount" value="0" min="1" readonly></td>
                                        <td><input type="text" class="form-control" id="price" value="0" min="1" ></td>
                                        <td><input type="text" class="form-control" id="quantity" onkeyup="change_total()" value="0" min="1"></td>
                                        <td><input type="text" class="form-control" id="price" value="0" min="1" readonly></td>
        ...
        function change_total(){
            ...
            var amount = $('#total_price').val(price);
            $('#cartFooter').show();
        }
