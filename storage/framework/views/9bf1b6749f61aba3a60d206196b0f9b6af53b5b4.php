                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td nowrap="">
                              ...
                              <a class="btn btn-flat bg-purple" href="<?php echo e(route('paymentvoucher-destroy-route',['id'=>$result->voucher_no])); ?>"><i class="fa fa-trash"></i></a>
                           </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </tbody>
               ...
               <div class="row"style="margin-top: 15px" >
                  <div class="col-md-12 table-responsive">
                     ...
                     <div class="col-md-4 text-right" >
                        <a href="<?php echo e(route('paymentvouchar-create-route')); ?>" class="btn btn-flat bg-purple">Create Payment</a>
                     </div>
                  </div>
               </div>
            </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/main/admin/accounts/pay_voucher_list.blade.php ENDPATH**/ ?>