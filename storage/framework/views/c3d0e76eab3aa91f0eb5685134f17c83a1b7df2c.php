...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li class=""><a href="#">SERIAL RECORD</a></li>
   </ol>
</section>
<!-- Main content -->
                           ...
                           <div class="etat_content">
                              <div class="page_split">
                                 ...
                                 <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <td><?php echo e($data->project->name); ?></td>
                                    <td><?php echo e($data->sales_invoice); ?></td>
                                    <td><?php echo e($data->project->address); ?></td>
                                    <td><?php echo e($data->project->status); ?></td>
                                    </tr>
                                    </tbody>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </table>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New_falcon_laravel\resources\views/main/admin/report/rep_invSerialRecord.blade.php ENDPATH**/ ?>