                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                    <label><?php if( Auth::User()->language == 1 ): ?> কনফার্ম পাসওয়ার্ড <?php else: ?> Confirm Passworর <?php endif; ?></label>
                                                        <div class="input-group">
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/user_role/user_create.blade.php ENDPATH**/ ?>