...
?>
    ...
    <h1><?php if( Auth::User()->language == 1 ): ?> পারচেস লিস্ট <?php else: ?> Purchase List <?php endif; ?></h1>
        <ol class="breadcrumb">
        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> পারচেস লিস্ট <?php else: ?> Purchase List <?php endif; ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> পারচেস রেকর্ড <?php else: ?> Purchase Record <?php endif; ?></h3>
        </div>
        <div class="box-body">
                    <?php if($errors->any()): ?>
        ...
        <tr>
            ...
            <td nowrap="">
                ...
                <a class="btn btn-flat bg-purple details-invoice" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo e(route('purchase-delete-page',$data->pur_invoice)); ?>"><i class="fa fa-trash cat-child"></i></a>
                </td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
        ...
        <a href="<?php echo e(route('purchase-create-page')); ?>" class="btn btn-flat bg-purple"><?php if( Auth::User()->language == 1 ): ?> ক্রিয়েট পারচেস <?php else: ?> Create Purchase <?php endif; ?></a>
        </div>
        </div>
        </div>
        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/nationa2/app.nationalgreencare.com/resources/views/main/admin/purchase/purchase_list.blade.php ENDPATH**/ ?>