	       ...
	       <div class="col-md-10">
	          <div class="box box-solid">
	             ...
	             <div class="box-body">
	               ...
	               <?php endif; ?>
				   <form action="<?php echo e(route('materialupdate', [$data->id])); ?>" method="post" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
				    <div class="row ">
