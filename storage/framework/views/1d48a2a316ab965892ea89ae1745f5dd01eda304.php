                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="">
                           ...
                           <li class="invpiv" >
                              ...
                              <p><strong class="pino"><?php echo e($expense->project->project_id); ?></strong><br><br><strong><?php echo e(date('d-m-Y', strtotime($expense->date))); ?></strong></p>
                              <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>T: ৳ <?php echo number_format("$expense->grand_total",2) ?></strong></div>
                           </li>
                        </a>
                     ...
                     <div class="printableArea">
                        ...
                        <div class="wrapper" style="width: 407.726px; height: 574.703px; overflow: hidden;">
                           <div id="wrap_invoice" class="page A4 portrait" style="transform: scale(0.51); transform-origin: 10px 0px 0px;">
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                       <img src="data:image/png;base64,<?php echo e(DNS1D::getBarcodePNG($expense->project->project_id, 'C39')); ?>" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Item :</strong> <?php echo e($expense->product->name); ?>

                                       <br><strong>Date:</strong><?php echo e(date('d-m-Y', strtotime($expense->date))); ?>
                              ...
                              <center>
                                 <h3 class="page-title">Daily Expense INVOICE</h3>
                              </center>
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                       <thead>
                                        <tr>
                                            ...
                                            <th style="width:12.5% !important;">Tequisition Item</th>
                                      ...
                                      <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td class="text-md-right"><?php echo e($data->unit->name); ?></td>
                                            <td class="text-md-center"><?php echo e($data->nprice); ?></td>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/rmc_construction/final_v5/rmc_final/resources/views/main/admin/dailyprocess/daily_expense_view.blade.php ENDPATH**/ ?>