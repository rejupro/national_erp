...
?>
    ...
    <h1><?php if( Auth::User()->language == 1 ): ?> ব্রাঞ্চ স্টক <?php else: ?> Branch Stock <?php endif; ?></h1>
        <ol class="breadcrumb">
        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> ব্রাঞ্চ স্টক <?php else: ?> Branch Stock <?php endif; ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> ব্রাঞ্চ স্টক স্ট্যাটাস <?php else: ?> Branch Stock Status <?php endif; ?></h3>
        </div>
        <div class="box-body">
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/inventory/branch_stock.blade.php ENDPATH**/ ?>