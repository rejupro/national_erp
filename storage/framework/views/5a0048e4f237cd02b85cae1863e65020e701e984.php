                                            ...
                                            <div class="form-group">
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-groups-item">
                                                        ...
                                                        <div class="material-switch pull-right">
                                                            <input id="master" name="loan" value="loan" type="checkbox" class="access" checked="">
                                                            <label for="master" class="label-success"></label>
                                                        </div>
                                                    </li>
                                                    <li class="list-groups-item">
                                                    ...
                                                    <li class="list-groups-item">
                                                        LC Setup
                                                        <div class="material-switch pull-right">
                                                            <input id="master" name="lc" value="lc" type="checkbox" class="access" checked="">
                                                            <label for="master" class="label-success"></label>
                                                        </div>
                                                    </li>
                                                    <li class="list-groups-item">
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/main/admin/user_role/role_create.blade.php ENDPATH**/ ?>