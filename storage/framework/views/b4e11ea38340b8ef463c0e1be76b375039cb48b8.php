...
$menuh='Report';
$phead='report';
$page='Supplier Balance';
$ractive='B';
$print='print';
$dtnow = date("Y-m-d h:i:s", time());
$today = strftime("%Y-%m-%d", time());
$oavno='REP'.date("dmy", strtotime($today)).'PAYSB';
?>

<section class="content-header">
  <h1>Supplier Balance</h1>
  <ol class="breadcrumb">
   <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
   <li><a href="mas_brandcreate.php">Report</a></li>
   <li class=""><a href="#">Supplier Balance</a></li>
 </ol>
</section>
<!-- Main content -->
            ...
            <div class="printableArea">    
             ...
             <div class="wrapper" style="background: none;">    
              <div id="wrap_invoice" class="page A4 landscape">
                ...
                <center>
                  <h3 class="page-title">Supplier Balance</h3>
                </center>    
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/main/admin/report/rep_paysupllierbalance.blade.php ENDPATH**/ ?>