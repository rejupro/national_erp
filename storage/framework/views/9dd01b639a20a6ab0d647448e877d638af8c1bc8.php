...
<section class="content-header">
    <h1><?php if( Auth::User()->language == 1 ): ?> পারচেস ক্রিয়েট <?php else: ?> Purchase Create <?php endif; ?></h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> পারচেস ক্রিয়েট <?php else: ?> Purchase Create <?php endif; ?></a></li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-solid">
                <div class="box-body">
                    <form action="<?php echo e(route('add_product_details')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">  
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="invoice" name="purchase_track" placeholder="e.g. PRCS-INV-0000" value="<?php echo e($invoice); ?>" readonly="readonly" autocomplete="off">  
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="65px" id="sbtl">SubTotal</th>
                                    ...
                                    <table class="table table-bordered table-striped" style="margin-bottom: 0;">    
                                        <tbody id="itemdata">
                                            ...
                                            <?php 
                                                ...
                                                // print_r($id = $i);
                                            ?>
                                            <!-- <tr class="remove_carts_item<?php echo e($carts->id); ?>">
                                                ...
                                                <td class="accordion-toggle" style="cursor: pointer;" width="190px">
                                                    <a href="#"  onclick="collaps(<?php echo e($id=$i); ?>)"><?php echo e($carts->item_name); ?></a>
                                                ...
                                                <td width="60px">
                                                    <input type="text" min="1" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" class="form-control quantity" id="quantity<?php echo e($i); ?>" name="quantity[]" value="1" size="2" style="height: 24px;">
                                                </td>
                                                
                                                <td width="65px" class="text-right" id="sbtt">
                                                    <input type="text" class="form-control price" id="price<?php echo e($i); ?>" value="0" name="price[]" onchange="product_grand_total(<?php echo e($i); ?>)" size="2" style="height: 24px;">
                                                </td>
                                                <td width="60px" id="grtt">
                                                    ...
                                                    <div class="accordian-body" id="pitem<?php echo e($i); ?>">
                                                        <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disp" id="pur_discount<?php echo e($i); ?>" value="0" name="pur_discount[]" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" size="2" style="height: 24px;">
                                                                    </td>

                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disf" id="pur_discount_amount<?php echo e($i); ?>" name="pur_discount_amount[]" value="0" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" size="2" style="height: 24px;">
                                                                    </td>
                                                                    <td id="pur_discount_amount<?php echo e($i); ?>" class="text-right">0</td>
                                                                    <td>
                                                                        <input type="text" min="1" class="form-control wdays" name="warranty[]" id="warranty<?php echo e($i); ?>" value="0" size="2" style="height: 24px;">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="0" id="sal_discount<?php echo e($i); ?>" class="form-control sdisp"value="0" name="sal_discount[]" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" size="2" style="height: 24px;">
                                                                    </td>
                                                                    <td>
                            ...
                            <div class="row" id="extra">
                                <div class="col-md-6">
                                    <input type="button" id="emptycart" class="btn btn-flat bg-red btn-sm" value="<?php if( Auth::User()->language == 1 ): ?> খালি <?php else: ?> Empty <?php endif; ?>">
                                </div>
                                <div class="col-md-6 text-right">
                                    <input type="submit" id="save_purchase" class="btn btn-flat bg-purple btn-sm" value="<?php if( Auth::User()->language == 1 ): ?> চেকআউট <?php else: ?> Checkout <?php endif; ?>">
                                </div>
                            </div>    
...
<input type="hidden" name="total_prchase" id="total_prchase" value="0">
    ...
    <script type="text/javascript">
        function cartData() {
            $.ajax({
                type:'get',
                url:'<?php echo e(route('ajax_cartdata')); ?>',
                success:function(response){
                    ...
                    $.each(response.data, function(key, value){
                        ...
                        allCartData += `<tr>
                                            ...
                                            <input type="hidden" name="item_id[]" id="item_id${value.id}'" value="${value.product_id }"></td>
                                            <td class="text-center" width="30px"><a href="#" onclick="expand(${i+1})"> ${i+1}</a></td>
                                            <td class="accordion-toggle" style="cursor: pointer;" width="190px">
                                                <a href="#"  onclick="collaps(${i+1})">${value.item_name }</a>
                                                <input type="hidden" name="item_name[]" value="${value.item_name }" readonly="readonly">
                                            </td>
                                            
                                            <td width="60px">
                                                <input type="text" min="1" class="form-control cost" id="cost${ i + 1 }" value="${value.cost}" name="cost[]" size="2" style="height: 24px;">
                                            </td>
                                            <td width="60px">
                                                <input type="text" min="1" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(${i+1})" class="form-control quantity" id="quantity${ i+1 }" name="quantity[]" value="${value.quantity}" size="2" rejuid="${value.id}" style="height: 24px;">
                                            </td>
                                            
                                            <td width="65px" class="text-right" id="sbtt">
                                                <input type="text" class="form-control price" id="price${i+1}" value="${value.price}" name="price[]" onchange="product_grand_total(${i+1})" size="2" style="height: 24px;" readonly>
                                            </td>
                                            <td width="60px" id="grtt">
                                                <input type="text" min="1" class="form-control price" id="grand_total${i+1}" name="grand_total[]" value="${value.grand_total}" size="2" style="height: 24px;" readonly>
                                            </td>
                                            <td class="text-center" width="25px">
                                                <a href="#" onclick="remove_from_cart( ${value.id} )" class="remove">
                                                    <span style="cursor: pointer;" class="fa fa-times"></span>
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="8" class="" id="sub_table${ i+1 }" style="display: none;">
                                                <div class="accordian-body" id="pitem${ i+1 }">
                                                    <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                                        <thead>
                                                            <tr>
                                                                <th colspan="3" class="text-center">Purchase Discount</th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input type="text" min="0" class="form-control disp" id="pur_discount${ i+1 }" value="0" name="pur_discount[]" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(${ i+1 })" size="2" style="height: 24px;">
                                                                </td>

                                                                <td>
                                                                    <input type="text" min="0" class="form-control disf" id="pur_discount_amount${ i+1 }" name="pur_discount_amount[]" value="0" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(${ i+1 })" size="2" style="height: 24px;">
                                                                </td>
                                                                <td id="pur_discount_amount${ i+1 }" class="text-right">0</td>
                                                                <td>
                                                                    <input type="text" min="1" class="form-control wdays" name="warranty[]" id="warranty${ i+1 }" value="0" size="2" style="height: 24px;">
                                                                </td>
                                                                <td>
                                                                    <input type="text" min="0" id="sal_discount${ i+1 }" class="form-control sdisp"value="0" name="sal_discount[]" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(${ i+1 })" size="2" style="height: 24px;">
                                                                </td>
                                                                <td>
                                                                    <input type="text" min="0" id="sal_discount_amount<?php echo e($i); ?>" class="form-control sdisf" name="sal_discount_amount[]" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(${ i+1 })" value="0" size="2" style="height: 24px;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                        <tfoot>
                    ...
                    $('tbody#itemdata').html(allCartData);
                },
                error:function(){
    ...
    <script type="text/javascript">
        function search_product_by_alphabet($id) {
            ...
            $.ajax({
                type:'get',
                url:'<?php echo e(route('search_product_by_alphabet')); ?>',
                data:{'id':search_data},
    ...
    <script type="text/javascript">
        function search_product() {
            ...
            $.ajax({
                type:'get',
                url:'<?php echo e(route('search_product_by_name')); ?>',
                data:{'id':search_data},
                success:function(product){
                  $("#purchaseitem").html(product);
                    return false;
    ...
    <script type="text/javascript">
        function search_by_name_code() {
            ...
            $.ajax({
                type:'get',
                url:'<?php echo e(route('search_product_by_name_code')); ?>',
                data:{'id':search_data},
                success:function(product){
                  $("#purchaseitem").html(product);
                    return false;
            ...
            $.ajax({
                ...
                success:function(product){
                    window.setTimeout(function () {
                        window.location.href = "<?php echo e(route('purchase-create-page')); ?>";
                    }, 100);
                    return false;
                },
                error:function(){
    ...
    <script type="text/javascript">
        function remove_from_cart($id) {
            var product_id = $id;
            var removeclassname = '.remove_carts_item' + product_id;
            $.ajax({
                type:'get',
                url:'<?php echo e(route('delete_cart_list')); ?>',
                data:{'id':product_id},
                success:function(product){
                    window.setTimeout(function () {
                        window.location.href = "<?php echo e(route('purchase-create-page')); ?>";
    ...
    <script type="text/javascript">
        function product_sub_total_with_quantity($id){
            ...
            if(pur_discount>0){
                ...
                var set_discount_amount = (parseFloat(pur_discount)/100) * parseFloat(set_price);
                ...
                var set_price = (parseFloat(quantity) * parseFloat(cost));
                var total_amount = $('#total_amount').val();
                var set_discount = (parseFloat(pur_discount_amount)/parseFloat(pur_discount_amount)) * 100 ;
                $('#pur_discount' +set_id+ "").val(set_discount);
                var set_sub_total = parseFloat(set_price) - parseFloat(pur_discount_amount);
                var full_total = $('#total_prchase').val();
                    // if(full_total == 0){
                    //     $('#total_prchase').val(set_sub_total);
                    //     $('#total_amount').val(set_sub_total);
            ...
            // Cart Update
            var cqty = $("#quantity"+set_id).val();
            var helloqty = "#quantity"+set_id;
            var ccost = $("#cost"+set_id).val();
            var cprice = $("#price"+set_id).val();
            var cgrand_total = $("#grand_total"+set_id).val();
            var cpostid = $(helloqty).attr('rejuid');
            
            var url = "<?php echo e(route('ajax_cartdataupdate', ":id")); ?>";
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    quantity:cqty,cost:ccost,price:cprice,grand_total:cgrand_total
                },
                url: url,
