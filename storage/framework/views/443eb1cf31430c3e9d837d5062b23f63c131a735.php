                  ...
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <li class="invpiv active" id="pi_64">
                           <p><strong class="pino"><?php echo e($data->purchase_track); ?></strong><br><strong class="name"><?php echo e($data->item_name); ?></strong><br><strong></strong></p>
                           <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>Q: ৳ <?php echo number_format("$data->quantity",2) ?></strong><br><strong>T: ৳ <?php echo number_format("$data->total",2) ?></strong></div>
                        </li>
                     ...
                     <div class="printableArea">
                        ...
                        <div class="wrapper" style="width: 407.726px; height: 574.703px; overflow: hidden;">
                           <div id="wrap_invoice" class="page A4 portrait" style="transform: scale(0.51); transform-origin: 10px 0px 0px;">
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,<?php echo e(DNS1D::getBarcodePNG($data->purchase_track, 'C39')); ?>" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Receive N°:</strong> <?php echo e($data->purchase_track); ?>

                                        <br><strong>Supplier Name:</strong> <?php echo e($data->supplier_name); ?>
                              ...
                              <center>
                                 <h3 class="page-title">RECEIVE INVOICE</h3>
                              </center>
                                 ...
                                 <div class="page_split">
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td class="text-md-left"><?php echo e($data->purchase_track); ?></td>
                                             <td class="text-md-right"><?php echo number_format("$data->price",2) ?></td>
                                             <td class="text-md-center"><?php echo number_format("$data->quantity",2) ?></td>
                                             <td class="text-md-center"><?php echo number_format("$data->discount",2) ?></td>
                                             <td class="text-md-right"><?php echo number_format("$data->total",2) ?></td>
                                          </tr>
                                    ...
                                    <p>
                                       ...
                                       <span style="text-transform: uppercase;">
                                        <?php echo e(NumConvert::word($data->grand_total)); ?>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/inventory/receive_view.blade.php ENDPATH**/ ?>