               ...
               <div class="col-md-3">
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="<?php echo e(route('sales-view-page',['id'=>$lists->id])); ?>">
                           <?php if($lists->sales_invoice==$results->sales_invoice): ?>
                           <li class="invpiv active" >
                           <?php else: ?>
                           <li class="invpiv" >
                           <?php endif; ?>
                              <p><strong class="pino"><?php echo e($lists->sales_invoice); ?></strong><br><br><strong><?php echo e(date('d-m-Y', strtotime($lists->sales_date))); ?></strong></p>
                              ...
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,<?php echo e(DNS1D::getBarcodePNG($results->sales_invoice, 'C39')); ?>" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br>
                                        <strong>Invoice N°:</strong> <?php echo e($results->sales_invoice); ?>

                                        <br><strong>Customer Name:</strong> <?php echo e($details->supplier_name); ?>
