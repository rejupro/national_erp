...
<section class="content-header">
    ...
    <section class="content">
        <form action="<?php echo e(route('sales-store-page')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="box box-solid">
                <input type="hidden" value="<?php echo e($invoice); ?>" id="sales_invoice" name="sales_invoice" readonly=""> 
                <input type="hidden" value="<?php echo e($cusid); ?>" id="cusid" name="cusid" readonly=""> 
                <div class="box-body">   
                    <div class="row"> 
                        <div class="col-md-12">
                                    ...
                                    <div class="addpurchase">
                                        <div class="row">
                                                ...
                                                <div class="small-box">
                                                    <div class="inner">
                                                        <h3 id="pabamo">
                                                            ...
                                                            <?php echo e($sales->grand_total); ?>

                                                        </h3>
                                                        <p>Total Payable</p>
                                                    </div>   
                                                </div>
                                                <input type="hidden" value="<?php echo e($sales->grand_total); ?>" id="payable" name="payable" readonly="">  
                                            </div>
                                            <div class="col-md-4 col-xs-4">
                                                <div class="small-box">
                                                    <div class="inner">
                                            ...
                                            <div class="col-md-4 col-xs-4">
                                                ...
                                                <input type="hidden" value="<?php echo e($sales->grand_total); ?>" id="due" name="due" readonly="">  
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-xs-6">
                                                <div class="form-group">
                                                    <label>Paid</label>    
                                                    <input type="text" maxlength="10" class="form-control cashr" name="paid" value="0" id="paid" onchange="return pay_amount()" placeholder="e.g. 500" autocomplete="off">    
                                                </div>    
                                            </div>
                                            <div class="col-md-2 col-xs-6">
                                                <div class="form-group">
                                                    <label>Sales Date</label>
                                                    <input type="text" class="form-control datetimepicker" name="sales_date" id="purdt" value="<?php echo e(date('Y-m-d', strtotime(now()))); ?>" placeholder="Sales Date" autocomplete="off" readonly="">
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-xs-6">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2 select2-hidden-accessible" name="product_store" id="ivt" tabindex="-1" aria-hidden="true">
                                                        <optgroup label="Branch">
                                                                ...
                                                                <option value="BR-<?php echo e($data->id); ?>" <?php if($data->id== session()->get('brand_id')): ?> selected <?php endif; ?>><?php echo e($data->id); ?> - <?php echo e($data->name); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2 select2-hidden-accessible" name="project_id" id="project_id" tabindex="-1" aria-hidden="true">
                                                        ...
                                                        <?php $__currentLoopData = $project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                                                            <option value="<?php echo e($data->id); ?>"><?php echo e($data->project_id); ?>
                                ...
                                <div class="invhold scrol-y" id="invhold">
                                    ...
                                    <div class="col-md-12 cart-border-left text-center">
                                        ...
                                        <div class="text-center header-line-height">
                                            ...
                                            <br> <small class="text-left">Sold By: <?php echo e($sales->supplier_name); ?></small> 
                                            <br> <small><span>Sales From: <?php echo e($sales->company_name); ?></span></small> 
                                            <small class="text-left invoice-show" style="display: none;">Invoice ID:<?php echo e($sales->sale_track); ?></small>
                                        </div> 
                                        <div class="invoice-table">
                                            <table class="table product-card-font" style="font-weight: 500;">
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr>
                                                        <td class="cart-summary-table font-weight-bold text-left">Discount(<?php echo e($sales->discount); ?>%)</td> 
                                                        <td class="cart-summary-table"></td>
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table">TK <?php echo e($sales->discount_amount); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="cart-summary-table font-weight-bold text-left">VAT(<?php echo e($sales->vat); ?>%)</td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk <?php echo e($sales->vat_amount); ?></td>
                                                    </tr>    
                                                    <tr>
                                                        <td class="cart-summary-table font-weight-bold text-left">TAX(<?php echo e($sales->tax); ?>%)</td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk <?php echo e($sales->tax_amount); ?></td>
                                                    </tr>    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk <?php echo e($sales->speed_money_amount); ?></td>
                                                    </tr>    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk <?php echo e($sales->freight_amount); ?></td>
                                                    </tr>    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk  <?php echo e($sales->fraction_discount_amount); ?></td>
                                                    </tr>    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk  <?php echo e($sales->grand_total); ?></td>
                                                    </tr> 
                                                </tfoot>
                                            </table>
                                        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/sales/sales_checkout.blade.php ENDPATH**/ ?>