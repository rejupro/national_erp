                ...
                <div class="row"style="margin-top: 15px" >
                   <div class="col-md-12 table-responsive">
                      ...
                      <div class="col-md-4 text-right" >
                         <a href="<?php echo e(route('product-create-route')); ?>" class="btn btn-flat bg-purple">Add Category</a>
                      </div>
                   </div>
                </div>
             </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/rmc_construction/final_v5/rmc_final/resources/views/main/admin/productsetup/product_list.blade.php ENDPATH**/ ?>