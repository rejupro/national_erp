...
?>
    <section class="content-header">
        <h1><?php if( Auth::User()->language == 1 ): ?> কন্ট্রাকটর ক্রিয়েট <?php else: ?> Contractor Create <?php endif; ?></h1>
        <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> কন্ট্রাকটর ক্রিয়েট <?php else: ?> Contractor Create <?php endif; ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> কন্ট্রাকটর ক্রিয়েট <?php else: ?> Contractor Create <?php endif; ?></h3>
        </div>
        <div class="box-body">
            <?php if($errors->any()): ?>
            ...
            <?php endif; ?>
        <form action="<?php echo e(route('project-contractor-store-page')); ?>" onsubmit="return validate()" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            <?php echo csrf_field(); ?>
            <div class="col-md-12 popup_details_div">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" maxlength="15" value="<?php echo e($results); ?>" readonly="readonly" id="code" class="form-control" placeholder="e.g. ABA/CO/001" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="row"style="margin-top: 15px" >
                    ...
                    <div class="col-md-4 text-right" >
                        <input type="submit" name="save_contractor" id="submit" class="btn btn-flat bg-purple btn-sm" value="<?php if( Auth::User()->language == 1 ): ?> সেভ <?php else: ?> Save <?php endif; ?>"/> <a href="<?php echo e(route('project-contractor-list-page')); ?>" class="btn btn-flat bg-gray"><?php if( Auth::User()->language == 1 ): ?> ক্লোজ <?php else: ?> Close <?php endif; ?></a>
                    </div>
                </div>
        </form>
        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/nationa2/app.nationalgreencare.com/resources/views/main/admin/manage_project/project_contractor_create.blade.php ENDPATH**/ ?>