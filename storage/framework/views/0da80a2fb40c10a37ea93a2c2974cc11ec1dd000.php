               ...
               <div class="col-md-3">
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="<?php echo e(route('receivevoucher-view-route',['id'=>$lists->voucher_no])); ?>">
                            ...
                            <?php endif; ?>
                              ...
                              <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>T: ৳ <?php echo number_format("$lists->amount",2) ?></strong></div>
                           </li>
                        </a>
                              ...
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                       <img src="data:image/png;base64,<?php echo e(DNS1D::getBarcodePNG($data->voucher_no, 'C39')); ?>" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Receipt N°:</strong> <?php echo e($data->voucher_no); ?>
                                        ...
                                        <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-md-left"><?php echo e($name); ?></td>
                                                        <td class="text-md-left"><?php if($detail->receive_to=="LE_5"): ?> Cash <?php else: ?> Bank <?php endif; ?></td>
                                                        <td style="text-align:left;"><?php echo e($detail->cheque_no); ?></td>
                                                        <td style="text-align:left;"><?php if($detail->cheque_date!=null): ?><?php echo e(date('d-m-Y', strtotime($detail->cheque_date))); ?> <?php endif; ?></td>
                                                        <td class="text-md-right"><?php echo number_format("$detail->amount",2) ?></td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td id="total" style="text-align:right;"><?php echo number_format("$data->amount",2) ?></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/main/admin/accounts/rev_voucher_view.blade.php ENDPATH**/ ?>