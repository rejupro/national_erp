...
$menuh='Report';
$phead='report';
$page='Internal Transaction';
$ractive='E';
$print='print';
$dtnow = date("Y-m-d h:i:s", time());
$today = strftime("%Y-%m-%d", time());
$oavno='REP'.date("dmy", strtotime($today)).'VINT';
?>
<section class="content-header">
  ...
  <ol class="breadcrumb">
     ...
     <li class=""><a href="#">Internal Transaction</a></li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
    ...
    <center>
    <h3 class="page-title">Internal Transaction</h3>
    </center>    
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New_falcon_laravel\resources\views/main/admin/report/rep_vouinternaltrans.blade.php ENDPATH**/ ?>