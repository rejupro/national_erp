                            ...
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                   onclick="event.preventDefault();
                                    ...
                                    <?php if($user->language == 1): ?> লগ আউট <?php else: ?> <?php echo e(__('Logoutt')); ?> <?php endif; ?>
                                </a>
...
</header><?php /**PATH C:\xampp\htdocs\erp\resources\views/layouts/admin/header.blade.php ENDPATH**/ ?>