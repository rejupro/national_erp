...
?>
    ...
    <section class="content-header">
	    <h1><?php if( Auth::User()->language == 1 ): ?> অন্যান্য ম্যাটেরিয়াল এড <?php else: ?> Ohter Material Add <?php endif; ?></h1>
	    <ol class="breadcrumb">
	        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
	        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> অন্যান্য ম্যাটেরিয়াল এড <?php else: ?> Ohter Material Add <?php endif; ?></a></li>
	     </ol>
    </section>
    <!-- Main content -->
	       ...
	       <div class="col-md-10">
	          <div class="box box-solid">
	             <div class="box-header with-border">
	                <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> অন্যান্য ম্যাটেরিয়াল এড <?php else: ?> Ohter Material Add <?php endif; ?></h3>
	             </div>
	             <div class="box-body">
	               ...
	               <?php endif; ?>
				   <form action="<?php echo e(route('other_rawmaterialstore')); ?>" method="post" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
				    <div class="row ">
...
unset($__errorArgs, $__bag); ?> form-control" placeholder="Material Name">
							...
							<div class="form-group">
								...
								<input type="number" name="price" maxlength="35" value="<?php echo e(old('price')); ?>" id="name" class="<?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
