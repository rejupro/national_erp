                  ...
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <li class="invpiv active" id="pi_64">
                           ...
                           <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>P: ৳ <?php echo number_format("$results->paid",2) ?></strong><br><strong>D: ৳ <?php echo number_format("$results->balance",2) ?></strong></div>
                        </li>
                                       ...
                                       <tbody>
                                        ...
                                        <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <tr>
                                             ...
                                             <td class="text-md-right"><?php echo number_format("$detail->price",2) ?></td>
                                          ...
                                          <tr>
                                             ...
                                             <td colspan="2" class="text-md-right font-weight-bold text-nowrap"><?php echo number_format("$detail->discount_amount",2) ?></td>
                                          </tr>
                                          <tr>
                                             <td colspan="2"></td>
                                             <td colspan="2" class="text-md-right font-weight-bold">Vat Amount</td>
                                             <td colspan="2" class="text-md-right font-weight-bold text-nowrap"><?php echo number_format("$detail->vat_amount",2) ?></td>
                                          </tr>
                                          <tr>
                                             <td colspan="2"></td>
                                             <td colspan="2" class="text-md-right font-weight-bold">Tax Amount</td>
                                             <td colspan="2" class="text-md-right font-weight-bold text-nowrap"><?php echo number_format("$detail->tax_amount",2) ?></td>
                                          </tr>
                                          <tr>
                                             <td colspan="2"></td>
                                             <td colspan="2" class="text-md-right font-weight-bold">Grand Total</td>
                                             <td colspan="2" class="text-md-right font-weight-bold text-nowrap"><?php echo number_format("$detail->grand_total",2) ?></td>
                                          </tr>
                                          <p>
                                            <b>Amount in words:
                                            </b>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/rmc_construction/final_v5/rmc_final/resources/views/main/admin/purchase/purchase_view.blade.php ENDPATH**/ ?>