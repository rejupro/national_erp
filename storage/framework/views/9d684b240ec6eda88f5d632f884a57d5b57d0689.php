...
$oavno='REP'.date("dmy", strtotime($today)).'RPURISL';
?>
                  ...
                  <div class="printableArea">
                     ...
                     <div class="wrapper" style="background: none;">
                        <div id="wrap_invoice" class="page A4 landscape">
                           ...
                           <center>
                              <h3 class="page-title">Item Statement</h3>
                           </center>
                           <div class="etat_content">
                              <div class="page_split">
                                 ...
                                 <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <th colspan="5" style="text-align:center;"><strong>Product Details</strong></th>
                                    </tr>
                                    <tr>
                                    <th>PU.Qty</th>
                                    <th>MRP</th>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/main/admin/report/rep_purItemst.blade.php ENDPATH**/ ?>