                                    ...
                                    <table class="table table-bordered table-striped" style="margin-bottom: 0;">     
                                        <tbody id="itemdata">
                                            ...
                                            <tr>
                                                ...
                                                <td width="60px">
                                                    <input type="text" min="1" onchange="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" class="form-control quantity" id="quantity<?php echo e($i); ?>" name="quantity[]" value="1" size="2" style="height: 24px;">
                                                </td>
                                                <td width="60px">
                                                    ...
                                                    <div class="accordian-body" id="pitem<?php echo e($i); ?>">
                                                        <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disp" id="pur_discount<?php echo e($i); ?>" name="pur_discount[]" value="0" onchange="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" size="2" style="height: 24px;" readonly="readonly">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disf" id="pur_discount_amount<?php echo e($i); ?>"  name="pur_discount_amount[]" value="0" onchange="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" readonly="readonly" size="2" style="height: 24px;">
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="0" id="sal_discount<?php echo e($i); ?>" class="form-control sdisp" name="sal_discount[]" value="0" onchange="product_sub_total_with_quantity(<?php echo e($id=$i); ?>)" size="2" style="height: 24px;">
                                                                    </td>
                                                                    <td>
