...
?>
    <section class="content-header">
        <h1><?php if( Auth::User()->language == 1 ): ?> লিভ অ্যাপ্লিকেশান <?php else: ?> Leave Application <?php endif; ?></h1>
        <ol class="breadcrumb">
        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> লিভ অ্যাপ্লিকেশান <?php else: ?> Leave Application <?php endif; ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> এড লিভ রেকুয়েস্ট <?php else: ?> Add Leave Request <?php endif; ?></h3>
        </div>
        <div class="box-body">
                    <?php if($errors->any()): ?>
        ...
        <input type="submit" name="save_lar" id="submit" class="btn btn-flat bg-purple btn-sm " value="<?php if( Auth::User()->language == 1 ): ?> সেভ <?php else: ?> Save <?php endif; ?>"/> <a href="<?php echo e(route('leaveapp-list-page')); ?>" class="btn btn-flat bg-gray  "><?php if( Auth::User()->language == 1 ): ?> ক্লোজ <?php else: ?> Close <?php endif; ?></a>
        </div>
        </div>
        </form>
        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/payroll/leaveapp_create.blade.php ENDPATH**/ ?>