...
<section class="content-header">
   <h1><?php if( Auth::User()->language == 1 ): ?> রিসিভ রেকর্ড <?php else: ?> Receive Record <?php endif; ?></h1>
   <ol class="breadcrumb">
      <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
      <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> রিসিভ রেকর্ড <?php else: ?> Receive Record <?php endif; ?></a></li>
   </ol>
</section>
<!-- Main content -->
      ...
      <div class="col-md-8">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> রিসিভ রেকর্ড <?php else: ?> Receive Record <?php endif; ?></h3>
            </div>
            <div class="box-body">
                  ...
                  <table class="table table-bordered table-striped" id="datarec">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td></td>
                           <?php endif; ?>
                           <td style="text-align:right;"><span>৳ </span><?php echo number_format("$result->amount",2) ?></td>
                           ...
                           <td nowrap="">
                              ...
                              <a class="btn btn-flat bg-purple" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo e(route('receivevoucher-destroy-route',['id'=>$result->voucher_no])); ?>"><i class="fa fa-trash"></i></a>
                           </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </tbody>
               ...
               <div class="row"style="margin-top: 15px" >
                  <div class="col-md-12 table-responsive">
                     ...
                     <div class="col-md-4 text-right" >
                        <a href="<?php echo e(route('receivevoucher-create-route')); ?>" class="btn btn-flat bg-purple"><?php if( Auth::User()->language == 1 ): ?> ক্রিয়েট রিসিভ <?php else: ?> Create Receive <?php endif; ?></a>
                     </div>
                  </div>
               </div>
            </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/accounts/rev_voucher_list.blade.php ENDPATH**/ ?>