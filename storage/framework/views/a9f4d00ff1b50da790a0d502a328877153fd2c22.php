...
$oavno='REP'.date("dmy", strtotime($today)).'PRJD';
?>
...
<section class="content">
    ...
    <li  <?php if($ractive=='C'): ?> class="active" <?php endif; ?>><a href="<?php echo e(route('project-contructorlist-report')); ?>">Contructor List</a></li>
    <li  <?php if($ractive=='D'): ?> class="active" <?php endif; ?>><a href="<?php echo e(route('project-contructorbalance-report')); ?>">Contructor Balance</a></li>
    <li  <?php if($ractive=='E'): ?> class="active" <?php endif; ?>><a href="<?php echo e(route('project-contructorstate-report')); ?>">Contructor Statement</a></li>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New_falcon_laravel\resources\views/main/admin/report/rep_prjprojectdetails.blade.php ENDPATH**/ ?>