<style>
    ...
    <footer class="main-footer">
        © 2010 - 2021. <a href="http://axesgl.com" target="_blank" style="font-weight: 1000!important;">Falcon Solutions LTD</a> - All Rights Reserved.<span class="footright"><i class="fa fa-heart" style="color: red;"></i> Crafted By S.M Shuvo<a href="callto:+8801762128000">(+8801762128000)</a></span>
     </footer>
...
setDatetimeHtml(this.value);
    ...
    <!-- /page script --><?php /**PATH C:\xampp\htdocs\New_falcon_laravel\resources\views/layouts/admin/footer.blade.php ENDPATH**/ ?>