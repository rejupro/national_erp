...
?>
    <section class="content-header">
        <h1><?php if( Auth::User()->language == 1 ): ?> ইউজার ক্রিয়েট <?php else: ?> User Create <?php endif; ?></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
            <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> ইউজার ক্রিয়েট <?php else: ?> User Create <?php endif; ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-solid">
                    ...
                    <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> এড নিউ ইউজার <?php else: ?> Add New User <?php endif; ?></h3>
                    </div>
                        <?php if($errors->any()): ?>
                    ...
                    <div class="box-body">
                        <form action="<?php echo e(route('user-store-page')); ?>" onsubmit="return validate()" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
                            ...
                            <div class="col-md-12 popup_details_div">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label><?php if( Auth::User()->language == 1 ): ?> পাসওয়ার্ড <?php else: ?> Password <?php endif; ?></label>
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                    <label><?php if( Auth::User()->language == 1 ): ?> কনফার্ম পাসওয়ার্ড <?php else: ?> Confirm Password <?php endif; ?></label>
                                                        <div class="input-group">
                            ...
                            <div class="row"style="margin-top: 15px" >
                                ...
                                <input type="submit" name="save_user" id="submit" class="btn btn-flat bg-purple btn-sm " value="<?php if( Auth::User()->language == 1 ): ?> সেভ <?php else: ?> Save <?php endif; ?>"/> <a href="<?php echo e(route('user-list-page')); ?>" class="btn btn-flat bg-gray  "><?php if( Auth::User()->language == 1 ): ?> ক্লোজ <?php else: ?> Close <?php endif; ?></a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/nationa2/app.nationalgreencare.com/resources/views/main/admin/user_role/user_create.blade.php ENDPATH**/ ?>