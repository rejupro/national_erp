...
?>
    <section class="content-header">
        ...
        <li class=""><a href="<?php echo e(route('employee-create-page')); ?>">Employee Create</a></li>
        </ol>
    </section>
    <!-- Main content -->
                    ...
                    <div class="box-body">
                        ...
                        <form action="<?php echo e(route('employee-store-page')); ?>" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
                            ...
                            <div class="row"style="margin-top: 15px" >
                                ...
                                <input type="submit" name="save_emp" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="<?php echo e(route('employee-list-page')); ?>" class="btn btn-flat bg-gray  ">Close</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/rmc_construction/final_v5/rmc_final/resources/views/main/admin/payroll/employee_create.blade.php ENDPATH**/ ?>