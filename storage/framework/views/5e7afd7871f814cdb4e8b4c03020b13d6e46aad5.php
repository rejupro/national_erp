...
<section class="content">
    ...
    <div class="box-body">
     ...
     <?php endif; ?>
    <form action="<?php echo e(route('company-store-create')); ?>" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
      <?php echo csrf_field(); ?>
    ...
    <div class="input-group">
    <span class="input-group-addon">AD</span>
    <textarea class="form-control" name="baddress" id="baddress" maxlength="350" rows="5" placeholder="ঠিকানা" ></textarea>
    </div>
    </div>
    </div>
    <div class="col-md-6">
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/main/admin/company/company_setting_create.blade.php ENDPATH**/ ?>