                  ...
                  <div class="printableArea">
                     ...
                     <div class="wrapper" style="background: none;">
                        <div id="wrap_invoice" class="page A4 landscape">
                           ...
                           <center>
                              <h3 class="page-title">SALES ITEM RECORD</h3>
                           </center>
                           <div class="etat_content">
                              <div class="page_split">
                                 ...
                                 <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <th colspan="4" style="text-align:center;"><strong>Sales Details</strong></th>
                                    </tr>
                                    <tr>
                                    <th>PU.Qty</th>
                                    <th>MRP</th>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/main/admin/report/sales_itemList.blade.php ENDPATH**/ ?>