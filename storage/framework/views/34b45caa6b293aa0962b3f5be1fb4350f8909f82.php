...
<script>
   ...
   $(document).ready(function(){
    ...
    function dynamic_field(number)
    {
     ...
     html = '<tr>';
           html += '<th style="width:200px;"><select class="form-control select2" name="debit_sub_group_id[]" ><option value="">-Select-</option><?php $__currentLoopData = $sub_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subgroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($subgroup['id']); ?>" <?php if(old('debit_sub_group_id') == $subgroup['id']): ?> selected <?php endif; ?>><?php echo e($subgroup['name']); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></th>';
           html += '<th style="width:200px;"><select class="form-control select2" name="debit_ledger_id[]"><option value="">-Select-</option><?php $__currentLoopData = $ledgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ledger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($ledger['id']); ?>" <?php if(old('debit_ledger_id') == $ledger['id']): ?> selected <?php endif; ?>><?php echo e($ledger['name']); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></th>';
           ...
           html += '<th style="width:200px;"><select class="form-control select2" name="credit_ledger_id[]"><option value="">-Select-</option> <?php $__currentLoopData = $ledgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ledger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($ledger['id']); ?>" <?php if(old('credit_ledger_id') == $ledger['id']): ?> selected <?php endif; ?>><?php echo e($ledger['name']); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></th>';
           html += '<th style="width:200px;"><select class="form-control select2" name="credit_sub_group_id[]"><option value="">-Select-</option><?php $__currentLoopData = $sub_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subgroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($subgroup['id']); ?>" <?php if(old('credit_sub_group_id') == $subgroup['id']): ?> selected <?php endif; ?>><?php echo e($subgroup['name']); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></th>';
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/rmc_construction/final_v5/rmc_final/resources/views/main/admin/accounts/jour_create.blade.php ENDPATH**/ ?>