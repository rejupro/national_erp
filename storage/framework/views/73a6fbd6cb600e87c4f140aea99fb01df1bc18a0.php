...
$oavno='REP'.date("dmy", strtotime($today)).'ALST';
?>
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
     ...
     <li class=""><a href="#">Ledger Statement</a></li>
 </ol>
</section>
<!-- Main content -->
                        ...
                        <div class="printableArea">    
                           ...
                           <div class="wrapper" style="background: none;">    
                            <div id="wrap_invoice" class="page A4 landscape">
                              ...
                              <center>
                                <h3 class="page-title">Ledger Statement</h3>
                            </center>    
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/main/admin/report/rep_accledgerstate.blade.php ENDPATH**/ ?>