      ...
      <ul class="sidebar-menu tree" data-widget="tree">
         ...
         <li class="treeview <?php if(isset($mhead) && $mhead=='daily'): ?> menu-open <?php endif; ?>">
            ...
            <ul class="treeview-menu" <?php if(isset($mhead) && $mhead=='daily'): ?> style="display: block;" <?php endif; ?>>
               ...
               <li><a href="<?php echo e(route('daily-sales-list-page')); ?>" <?php if(isset($phead) && $phead=='slsrprtlst'): ?> class="active" <?php endif; ?>><i class="fa fa-caret-right"></i> Daily Sales Report</a></li>
               <li><a href="<?php echo e(route('bike-reading-list-page')); ?>" <?php if(isset($phead) && $phead=='bikeread'): ?> class="active" <?php endif; ?>><i class="fa fa-caret-right"></i>Bike Reading Report</a></li>
            </ul>
         </li>
         <?php endif; ?>
        ...
        <?php endif; ?>
         ...
         <li class="treeview" <?php if(isset($mhead) && $mhead=='payroll'): ?> menu-open <?php endif; ?>>
            ...
            <ul class="treeview-menu" <?php if(isset($mhead) && $mhead=='payroll'): ?> style="display: block;" <?php endif; ?>>
               ...
               <li><a href="<?php echo e(route('salary-list-page')); ?>" <?php if(isset($phead) && $phead=='salarycreate'): ?> class="active" <?php endif; ?>><i class="fa fa-caret-right"></i> Salary List</a></li>
               <li><a href="<?php echo e(route('payslip-list-page')); ?>" <?php if(isset($phead) && $phead=='payrollcreate'): ?> class="active" <?php endif; ?>><i class="fa fa-caret-right"></i> Salary Payslip </a></li>
            </ul>
         </li>
         <?php endif; ?>
...
<?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/layouts/admin/aside.blade.php ENDPATH**/ ?>