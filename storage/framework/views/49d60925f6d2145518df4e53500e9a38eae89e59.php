...
$oavno='REP'.date("dmy", strtotime($today)).'AJRH';
?>
<section class="content-header">
    ...
    <ol class="breadcrumb">
       ...
       <li class=""><a href="#">Journal History</a></li>
    </ol>
 </section>
<!-- Main content -->
<section class="content">
    ...
    <center>
    <h3 class="page-title">Journal History</h3>
    </center>    
    <div class="etat_content">
        ...
        <h3 class="inv col"><b>History For: </b></h3>
        </div>    
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/main/admin/report/rep_accjournalhistory.blade.php ENDPATH**/ ?>