...
<section class="content-header">
   <h1><?php if( Auth::User()->language == 1 ): ?> এপ্রুভ রিকুইজিশন রেকর্ড <?php else: ?> Approve Requisition Record <?php endif; ?></h1>
   <ol class="breadcrumb">
   <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
      <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> এপ্রুভ রিকুইজিশন রেকর্ড <?php else: ?> Approve Requisition Record <?php endif; ?></a></li>
   </ol>
</section>
<!-- Main content -->
      ...
      <div class="col-md-12">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> এপ্রুভ রিকুইজিশন লিস্ট  <?php else: ?> Approve Requisition List <?php endif; ?></h3>
            </div>
            <div class="box-body">
                <?php if($errors->any()): ?>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td width="60px">
                              ...
                              <?php if($brid==1): ?>
                                  <a class="empty" onclick="return confirm('Are you sure you want to delete this item?');" style="cursor: pointer;" href="<?php echo e(route('requisition-delete-route',$data->code)); ?>"><i class="fa fa-trash"></i></a>
                              <?php endif; ?>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/requisition/requisition_approve_list.blade.php ENDPATH**/ ?>