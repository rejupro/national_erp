...
$menuh='Report';
$phead='report';
$page='Periodic Purchase Record';
$ractive='F';
$print='print';
$dtnow = date("Y-m-d h:i:s", time());
$today = strftime("%Y-%m-%d", time());
$oavno='REP'.date("dmy", strtotime($today)).'PURPL';
?>
<section class="content-header">
   <h1>Periodic Purchase Record</h1>
   <ol class="breadcrumb">
      <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
      <li><a href="mas_brandcreate.php">Report</a></li>
      <li class=""><a href="#">Periodic Purchase Record</a></li>
   </ol>
 </section>
<!-- Main content -->
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/main/admin/report/rep_purperiodic.blade.php ENDPATH**/ ?>