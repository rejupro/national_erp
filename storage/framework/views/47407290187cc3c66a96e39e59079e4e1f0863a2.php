<?php $__env->startSection("content"); ?>
    ...
    <section class="content-header">
        <h1><?php if( Auth::User()->language == 1 ): ?> সেলস ক্রিয়েট <?php else: ?> Sales Create <?php endif; ?></h1>
        <ol class="breadcrumb">
        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> সেলস ক্রিয়েট <?php else: ?> Sales Create <?php endif; ?></a></li>
        </ol>
    </section>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/nationa2/app.nationalgreencare.com/resources/views/main/admin/sales/sales_create.blade.php ENDPATH**/ ?>