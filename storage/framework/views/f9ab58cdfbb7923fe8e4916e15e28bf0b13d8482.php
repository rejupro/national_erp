                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="breadcrumbs">
                            <h2 class="breadcrumbs-title">Projects - Floor Hardener Solution</h2>
                            <ul class="breadcrumbs-list">
                                <li><a href="<?php echo e(route('index')); ?>">Home</a></li>
                                <li>Projects - Floor Hardener Solution</li>
                            </ul>
                        </div>
                    </div>
                </div>
