...
?>
    <section class="content-header">
     ...
     <section class="content">
        ...
        <div class="col-md-4">
        <div class="form-group">
        <label>Select Client/Department</label>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/rmc_construction/final_v5/rmc_final/resources/views/main/admin/manage_project/project_create.blade.php ENDPATH**/ ?>