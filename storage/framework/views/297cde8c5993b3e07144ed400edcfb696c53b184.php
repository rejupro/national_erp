...
$menuh='Report';
$phead='report';
$page='Supplier Overview';
$ractive='E';
$print='print';
$dtnow = date("Y-m-d h:i:s", time());
$today = strftime("%Y-%m-%d", time());
$oavno='REP'.date("dmy", strtotime($today)).'PAYSO';
?>
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
       ...
       <li class=""><a href="#">Supplier Overview</a></li>
    </ol>
  </section>
<!-- Main content -->
<section class="content">
    ...
    <center>
    <h3 class="page-title">Supplier Overview</h3>
    </center>    
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New_falcon_laravel\resources\views/main/admin/report/rep_paysupllieroverview.blade.php ENDPATH**/ ?>