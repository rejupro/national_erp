...
<section class="content-header">
   <h1><?php if( Auth::User()->language == 1 ): ?> পেইমেন্ট ক্রিয়েট <?php else: ?> Payment Create <?php endif; ?></h1>
   <ol class="breadcrumb">
      <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
      <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> পেইমেন্ট ক্রিয়েট <?php else: ?> Payment Create <?php endif; ?></a></li>
   </ol>
</section>
<!-- Main content -->
      ...
      <div class="col-md-12">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> পেইমেন্ট ক্রিয়েট <?php else: ?> Payment Create <?php endif; ?></h3>
            </div>
            <div class="box-body">
               ...
               <form id="dynamic_form"    enctype="multipart/form-data" method="post" accept-charset="utf-8">
                <?php echo csrf_field(); ?>
                  <div class="col-md-12 popup_details_div">
                     <div class="row">
                        <center>
                           <h3 class="page-title"><?php if( Auth::User()->language == 1 ): ?> পেইমেন্ট ভাউচার <?php else: ?> PAYMENT VOUCHER <?php endif; ?></h3>
                        </center>
                     </div>
                     <div id='result'></div>
                     <br>
                  ...
                  <div class="row"style="margin-top: 15px" >
                     ...
                     <div class="col-md-4 text-right" >
                        <input type="submit" name="save_journal" id="submit" class="btn btn-flat bg-purple btn-sm" value="<?php if( Auth::User()->language == 1 ): ?> সেভ <?php else: ?> Save <?php endif; ?>"/> <a href="<?php echo e(route('paymentvouchar-list')); ?>" class="btn btn-flat bg-gray "><?php if( Auth::User()->language == 1 ): ?> ক্লোজ <?php else: ?> Close <?php endif; ?></a>
                     </div>
                  </div>
               </form>
            </div>
   ...
   $(document).ready(function(){
    ...
    function dynamic_field(number)
    {
     ...
     html = '<tr>';
           ...
           html += '<th style="width:200px;"><input type="text"  style="width:200px;" maxlength="20" class="form-control" id="ämount'+count+'" name="amount[]" placeholder="e.g. 500" onchange="get_total_amount('+count+')" autocomplete="off"></th>';
    ...
    $('#dynamic_form').on('submit', function(event){
           ...
           $.ajax({
               url:'<?php echo e(route("paymentlist-store-route")); ?>',
               method:'POST',
               data:$(this).serialize(),
               dataType:'json',
               beforeSend:function(){
               ...
               success:function(data)
               {
                   ...
                   else
                   {
                     ...
                     //   $('#result').html('<div class="alert alert-success">'+data.success+'</div>');
                       window.location.href = "<?php echo e(route('paymentvouchar-list')); ?>";
                   }
...
<script>
   function countTotalCash($id){
      var set_id = $id;
      var led_id = $('#payment_source'+set_id+"").val();
      $.ajax({
         type:'get',
         url:'<?php echo e(route('countTotalCash')); ?>',
         data:{'id':led_id},
         success:function(product){
         $('#sbalance'+set_id+"").html(product);
            return false;
         },
         error:function(){
         },
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/accounts/pay_voucher_create.blade.php ENDPATH**/ ?>