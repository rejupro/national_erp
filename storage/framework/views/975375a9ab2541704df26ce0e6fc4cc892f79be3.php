...
<header class="main-header" >
    <a href="<?php echo e(route('home')); ?>" class="logo" >
        <img src="<?php echo e(asset($comp->image)); ?>" class="main_logo" style="margin-top: 5px; width: 180px; height: 60px;" />
...
</header><?php /**PATH /home/webases1/ayeshaerp.webase.solutions/resources/views/layouts/admin/header.blade.php ENDPATH**/ ?>