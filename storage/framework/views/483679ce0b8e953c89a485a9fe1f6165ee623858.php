            ...
            <ul>
                ...
                <div class="tabcontents">
                    ...
                    <div class="col-md-12">
                        ...
                        <br>
                        <h2>Supplier Receive Details</h2>
                        <div class="col-md-12">
                            <div class="row">
                            <div class="cart cart-sm">     
                            <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                ...
                                <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tbody id="tradata">
                                       ...
                                       <?php $__currentLoopData = $salesdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td style="width:40px;" class="center"><?php echo e($i++); ?></td>
                                            <td style="text-align:left; width:100px;"><?php echo e(date('d-m-Y', strtotime($datas2->purchase_date))); ?></td>
                                            <td style="text-align:left; width:90px;"><a class="btn btn-flat bg-purple" href="<?php echo e(route('purchese-view-page',['id' => $datas2->id])); ?>"><?php echo e($datas2->pur_invoice); ?></a></td>
