...
<?php $__env->startSection("content"); ?>  
    <section class="content-header">
        <h1><?php if( Auth::User()->language == 1 ): ?> প্রোজেক্ট সাব-গ্রুপ ইডিট <?php else: ?> Project Sub-Group Edit <?php endif; ?></h1>
        <ol class="breadcrumb">
     ...
     <section class="content">
        ...
        <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> প্রোজেক্ট সাব-গ্রুপ ইডিট <?php else: ?> Project Sub-Group Edit <?php endif; ?></h3>
        </div>
        <div class="box-body">
            <?php if($errors->any()): ?>
        ...
        <form action="<?php echo e(route('edit-prosubgroup-update',$subgroup->id)); ?>"  enctype="multipart/form-data" method="post" accept-charset="utf-8">
         <?php echo csrf_field(); ?>
            ...
            <div class="row"style="margin-top: 15px" >
                ...
                <input type="submit" name="save_subgroup" id="submit" class="btn btn-flat bg-purple btn-sm " value="<?php if( Auth::User()->language == 1 ): ?> আপডেট <?php else: ?> Update <?php endif; ?>"/> <a href="<?php echo e(route('prosubgroup-list-create')); ?>" class="btn btn-flat bg-gray  "><?php if( Auth::User()->language == 1 ): ?> ক্লোজ <?php else: ?> Close <?php endif; ?></a>
                </div> 
            </div>     
        </form>    
        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/main/admin/manage_project/project_subgroup_edit.blade.php ENDPATH**/ ?>