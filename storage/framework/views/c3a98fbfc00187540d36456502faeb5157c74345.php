...
<?php $__env->startSection("content"); ?>  
    <section class="content-header">
        <h1><?php if( Auth::User()->language == 1 ): ?> প্রোজেক্ট রেকর্ড ইডিট <?php else: ?> Project Record Edit <?php endif; ?></h1>
        <ol class="breadcrumb">
        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i><?php if( Auth::User()->language == 1 ): ?> ড্যাসবোর্ড <?php else: ?> Dashboard <?php endif; ?></a></li>
        <li class=""><a href=""><?php if( Auth::User()->language == 1 ): ?> প্রোজেক্ট রেকর্ড ইডিট <?php else: ?> Project Record Edit <?php endif; ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <h3 class="box-title"><?php if( Auth::User()->language == 1 ): ?> প্রোজেক্ট রেকর্ড ইডিট <?php else: ?> Project Record Edit <?php endif; ?></h3>
        </div>
        <div class="box-body">
            <?php if($errors->any()): ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="client" id="client">
                        ...
                        <option value="<?php echo e($customers->id); ?>" <?php echo ($project->client == $customers->id ? "selected" : ""); ?>><?php echo e($customers->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>    
                </div>
            </div>    
        ...
        <div class="col-md-2"></div>    
            ...
            <div class="row"style="margin-top: 15px" >
                ...
                <input type="submit" name="save_project" id="submit" class="btn btn-flat bg-purple btn-sm " value="<?php if( Auth::User()->language == 1 ): ?> আপডেট <?php else: ?> Update <?php endif; ?>"/> <a href="<?php echo e(route('project-list-page')); ?>" class="btn btn-flat bg-gray  "><?php if( Auth::User()->language == 1 ): ?> ক্লোজ <?php else: ?> Close <?php endif; ?></a>
                </div> 
            </div>     
        </form>    
        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/nationa2/app.nationalgreencare.com/resources/views/main/admin/manage_project/project_edit.blade.php ENDPATH**/ ?>