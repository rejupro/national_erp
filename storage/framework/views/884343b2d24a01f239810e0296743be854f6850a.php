                              ...
                              <div class="etat_content">
                                 <div class="page_split">
                                    ...
                                    <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Project Name</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;"><?php echo e($requisition->project->name); ?></span></p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Status</h4>
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td class="text-md-right"><?php echo e($data->nprice); ?></td>
                                            <td class="text-md-center"><?php echo e($data->qty); ?></td>
                                            <td class="text-md-center"><?php echo e($data->price); ?></td>
                                         </tr>
                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         <tr>
                                            <td colspan="2"></td>
                                            <td colspan="2" class="text-md-right font-weight-bold"> Total</td>
                                            <td colspan="2" class="text-md-right font-weight-bold text-nowrap"><?php echo e($requisition->grand_total); ?></td>
                                         </tr>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New_falcon_laravel\resources\views/main/admin/requisition/requisition_view.blade.php ENDPATH**/ ?>