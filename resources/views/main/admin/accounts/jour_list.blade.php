...
<section class="content-header">
   <h1>@if ( Auth::User()->language == 1 ) জার্নাল রেকর্ড @else Journal Record @endif</h1>
   <ol class="breadcrumb">
      <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
      <li class=""><a href="">@if ( Auth::User()->language == 1 ) জার্নাল রেকর্ড @else Journal Record @endif</a></li>
   </ol>
</section>
<!-- Main content -->
      ...
      <div class="col-md-8">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title">@if ( Auth::User()->language == 1 ) জার্নাল রেকর্ড @else Journal Record @endif</h3>
            </div>
            <div class="box-body">
               {{-- Error message show --}}
               @if ($errors->any())
                  ...
                  <table class="table table-bordered table-striped" id="datarec">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td></td>
                           @endif
                           <td><span>৳ </span> @php echo number_format("$data->total",2) @endphp</td>
                           <td>{{$data->ref}}</td>
                           <td nowrap="">
                              ...
                              <a class="btn btn-flat bg-purple" onclick="return confirm('Are you sure you want to delete this item?');" href="{{route('journallist-destroy-route',['id'=>$data->id])}}"><i class="fa fa-trash"></i></a>
                           </td>
                        </tr>
                        @endforeach
                     </tbody>
               ...
               <div class="row"style="margin-top: 15px" >
                  <div class="col-md-12 table-responsive">
                     ...
                     <div class="col-md-4 text-right" >
                        <a href="{{route('journallist-create-route')}}" class="btn btn-flat bg-purple">@if ( Auth::User()->language == 1 ) ক্রিয়েট জার্নাল @else Create Journal @endif</a>
                     </div>
                  </div>
               </div>
            </div>
