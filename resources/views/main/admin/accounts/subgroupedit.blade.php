...
<section class="content-header">
   <h1>@if ( Auth::User()->language == 1 ) ইডিট সাব-গ্রুপ @else Edit Sub-Group @endif</h1>
   <ol class="breadcrumb">
      <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
      <li class=""><a href="">@if ( Auth::User()->language == 1 ) ইডিট সাব-গ্রুপ @else Edit Sub-Group @endif</a></li>
   </ol>
</section>
<!-- Main content -->
      ...
      <div class="col-md-8">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title">@if ( Auth::User()->language == 1 ) ইডিট সাব-গ্রুপ @else Edit Sub-Group @endif</h3>
            </div>
            <div class="box-body">
                ...
                <div class="col-md-12 popup_details_div">
                  ...
                  <div class="row"style="margin-top: 15px" >
                     ...
                     <div class="col-md-4 text-right" >
                        <input type="submit" name="save_sgroup" id="submit" class="btn btn-flat bg-purple btn-sm " value="@if ( Auth::User()->language == 1 ) আপডেট @else Update @endif"/> <a href="{{route('subgroup-list')}}" class="btn btn-flat bg-gray  ">@if ( Auth::User()->language == 1 ) ক্লোজ @else Close @endif</a>
                     </div>
                  </div>
               </form>
            </div>
