...
<section class="content-header">
    <h1>@if ( Auth::User()->language == 1 ) পারচেস ক্রিয়েট @else Purchase Create @endif</h1>
    <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) পারচেস ক্রিয়েট @else Purchase Create @endif</a></li>
    </ol>
</section>
                    ...
                    <form action="{{ route('add_product_details') }}" method="POST">
                        ...
                        <div class="row">
                                    ...
                                    <table class="table table-bordered table-striped" style="margin-bottom: 0;">    
                                        <tbody id="itemdata">
                                            ...
                                            <?php 
                                                ...
                                                // print_r($id = $i);
                                            ?>
                                            <!-- <tr class="remove_carts_item{{$carts->id}}">
                                                ...
                                                <td width="60px">
                                                    <input type="text" min="1" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity({{ $id=$i }})" class="form-control quantity" id="quantity{{ $i }}" name="quantity[]" value="1" size="2" style="height: 24px;">
                                                </td>
                                                    ...
                                                    <div class="accordian-body" id="pitem{{ $i }}">
                                                        <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disp" id="pur_discount{{ $i }}" value="0" name="pur_discount[]" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity({{ $id=$i }})" size="2" style="height: 24px;">
                                                                    </td>

                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disf" id="pur_discount_amount{{ $i }}" name="pur_discount_amount[]" value="0" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity({{ $id=$i }})" size="2" style="height: 24px;">
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="0" id="sal_discount{{ $i }}" class="form-control sdisp"value="0" name="sal_discount[]" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity({{ $id=$i }})" size="2" style="height: 24px;">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="0" id="sal_discount_amount{{ $i }}" class="form-control sdisf" name="sal_discount_amount[]" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity({{ $id=$i }})" value="0" size="2" style="height: 24px;">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            <tfoot>
                            ...
                            <div class="row" id="extra">
                                <div class="col-md-6">
                                    <input type="button" id="emptycart" class="btn btn-flat bg-red btn-sm" value="@if ( Auth::User()->language == 1 ) খালি @else Empty @endif">
                                </div>
                                <div class="col-md-6 text-right">
                                    <input type="submit" id="save_purchase" class="btn btn-flat bg-purple btn-sm" value="@if ( Auth::User()->language == 1 ) চেকআউট @else Checkout @endif">
                                </div>
                            </div>    
...
<input type="hidden" name="total_prchase" id="total_prchase" value="0">
                                                    ...
                                                    <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" min="0" id="sal_discount_amount{{ $i }}" class="form-control sdisf" name="sal_discount_amount[]" onchange="calculate_total_grand()" onkeyup="product_sub_total_with_quantity(${ i+1 })" value="0" size="2" style="height: 24px;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                        <tfoot>
    ...
    <script type="text/javascript">
        function product_sub_total_with_quantity($id){
            ...
            var url = "{{ route('ajax_cartdataupdate', ":id") }}";
