               ...
               <div class="col-md-3">
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="{{route('sales-view-page',['id'=>$lists->id])}}">
                           @if($lists->sales_invoice==$results->sales_invoice)
                           <li class="invpiv active" >
                           @else
                           <li class="invpiv" >
                           @endif
                              <p><strong class="pino">{{$lists->sales_invoice}}</strong><br><br><strong>{{date('d-m-Y', strtotime($lists->sales_date))}}</strong></p>
                              ...
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($results->sales_invoice, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br>
                                        <strong>Invoice N°:</strong> {{$results->sales_invoice}}
                                        <br><strong>Customer Name:</strong> {{$details->supplier_name}}
