    ...
    <section class="content">
        <form action="{{ route('sales-store-page') }}" method="POST">
            ...
            <div class="box box-solid">
                ...
                <input type="hidden" value="{{ $cusid }}" id="cusid" name="cusid" readonly=""> 
                <div class="box-body">   
                    <div class="row"> 
                        <div class="col-md-12">
                                    ...
                                    <div class="addpurchase">
                                        <div class="row">
                                            <div class="col-md-4 col-xs-4">
                                                ...
                                                <input type="hidden" value="{{ $sales->grand_total }}" id="payable" name="payable" readonly="">  
                                            </div>
                                            <div class="col-md-4 col-xs-4">
                                                <div class="small-box">
                                                    <div class="inner">
                                            ...
                                            <div class="col-md-4 col-xs-4">
                                                ...
                                                <input type="hidden" value="{{ $sales->grand_total }}" id="due" name="due" readonly="">  
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-4 col-xs-4">
                                                <div class="small-box">
                                ...
                                <div class="invhold scrol-y" id="invhold">
                                    ...
                                    <div class="col-md-12 cart-border-left text-center">
                                        ...
                                        <div class="text-center header-line-height">
                                            ...
                                            <br> <small class="text-left">Sold By: {{ $sales->supplier_name }}</small> 
                                            <br> <small><span>Sales From: {{ $sales->company_name }}</span></small> 
                                            <small class="text-left invoice-show" style="display: none;">Invoice ID:{{ $sales->sale_track }}</small>
                                        </div> 
                                        <div class="invoice-table">
                                            <table class="table product-card-font" style="font-weight: 500;">
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr>
                                                        <td class="cart-summary-table font-weight-bold text-left">Discount({{ $sales->discount }}%)</td> 
                                                        <td class="cart-summary-table"></td>
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table">TK {{ $sales->discount_amount }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="cart-summary-table font-weight-bold text-left">VAT({{ $sales->vat }}%)</td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk {{ $sales->vat_amount }}</td>
                                                    </tr>    
                                                    <tr>
                                                        <td class="cart-summary-table font-weight-bold text-left">TAX({{ $sales->tax }}%)</td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk {{ $sales->tax_amount }}</td>
                                                    </tr>    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk {{ $sales->speed_money_amount }}</td>
                                                    </tr>    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk {{ $sales->freight_amount }}</td>
                                                    </tr>    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk  {{ $sales->fraction_discount_amount }}</td>
                                                    </tr>    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="cart-summary-table"></td> 
                                                        <td class="text-right cart-summary-table ">Tk  {{ $sales->grand_total }}</td>
                                                    </tr> 
                                                </tfoot>
                                            </table>
                                        </div>
