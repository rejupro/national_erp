...
@section("content")
    ...
    <section class="content-header">
        <h1>@if ( Auth::User()->language == 1 ) সেলস ক্রিয়েট @else Sales Create @endif</h1>
        <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) সেলস ক্রিয়েট @else Sales Create @endif</a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
                            ...
                            <div class="row" id="purchaseitem" >
                                ...
                                <div class="product-panel style-2"style="height: 185px;">
                                    @foreach($product as $products)
                                        <a href="#" onclick="add_to_cart({{ $id=$products->product_id }})">
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    <div class="box-body">
                        <form action="{{ route('add_purchase_details') }}" method="POST">
                            @csrf
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="invoice" name="purchase_track" placeholder="e.g. SALE-INV-0000" value="{{ $invoice }}" readonly="readonly" autocomplete="off">
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    {{--<div class="input-group">--}}
                                    {{--<span class="input-group-addon"><span class="fa fa-search"></span></span>--}}
                                    {{--<input type="text" class="form-control" id="pcode" onchange="return search_by_name_code()" placeholder="e.g. Product Code or Name" autocomplete="off">   <span class="input-group-addon"><a id="addpro"><span class="fa fa-plus"></span></a></span>--}}
                                    {{--</div>--}}
                                    {{--</div>--}}
                                    {{--</div>--}}
                                    <div class="col-md-4">
                                                ...
                                                @if($cart)
                                                    ...
                                                    @foreach($cart as $carts)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="accordion-toggle" style="cursor: pointer;" width="190px"><a href="#"  onclick="collaps({{ $id=$i }})">{{ $carts->item_name }}</a>
                                                            ...
                                                            <td width="60px">
                                                                <input type="text" min="1" onchange="calculate_total_grand()"  onkeyup="product_sub_total_with_quantity({{ $id=$i }})" class="form-control quantity" id="quantity{{ $i }}" name="quantity[]" value="0" size="2" style="height: 24px;">
                                                            </td>
                                                            ...
                                                            <td width="65px" class="text-right">
                                                                <input type="text" class="form-control price" id="price{{ $i }}" value="{{ $carts->cost }}" name="price[]" size="2" style="height: 24px;">
                                                            </td>
                                                            <td width="60px">
                                                            ...
                                                            <td colspan="8" class="" id="sub_table{{ $i }}" style="display: none;">
                                                                <div class="accordian-body" id="pitem{{ $i }}">
                                                                    <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text" min="0" class="form-control disp" id="pur_discount{{ $i }}" name="pur_discount[]" value="0" onchange="calculate_total_grand()"  onkeyup="product_sub_total_with_quantity({{ $id=$i }})" size="2" style="height: 24px;" readonly="readonly">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" min="0" class="form-control disf" id="pur_discount_amount{{ $i }}"  name="pur_discount_amount[]" value="0" onchange="calculate_total_grand()"  onkeyup="product_sub_total_with_quantity({{ $id=$i }})" readonly="readonly" size="2" style="height: 24px;">
                                                                            </td>
                                                                            <td id="pur_discount_amount{{ $i }}" class="text-right">0</td>
                                                                            <td>
                                                                                <input type="text" min="1" class="form-control wdays" id="warranty{{ $i }}" name="warranty[]" value="0" size="2" style="height: 24px;">
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" min="0" id="sal_discount{{ $i }}" class="form-control sdisp" name="sal_discount[]" value="0" onchange="calculate_total_grand()"  onkeyup="product_sub_total_with_quantity({{ $id=$i }})" size="2" style="height: 24px;">
                                                                            </td>
                                                                            <td>
    ...
    <script type="text/javascript">
        function search_product_by_alphabet($id) {
            ...
            $.ajax({
                type:'get',
                url:'{{ route('search_product_by_alphabet_for_sale') }}',
                data:{'id':search_data},
    ...
    <script type="text/javascript">
        function search_product() {
            ...
            $.ajax({
                type:'get',
                url:'{{ route('search_product_by_name_for_sale') }}',
                data:{'id':search_data},
                success:function(product){
                    $("#purchaseitem").html(product);
                    return false;
    ...
    <script type="text/javascript">
        function search_by_name_code() {
            ...
            $.ajax({
                type:'get',
                url:'{{ route('search_product_by_name_code_for_sale') }}',
                data:{'id':search_data},
                success:function(product){
                    $("#purchaseitem").html(product);
                    return false;
    ...
    <script type="text/javascript">
        function add_to_cart($id) {
            ...
            $.ajax({
                type:'get',
                url:'{{ route('add-to-cart_for_sale') }}',
                data:{'id':product_id},
                success:function(product){
                    window.setTimeout(function () {
                        window.location.href = "{{ route('sales-create-page') }}";
                    }, 100);
                    return false;
                },
                error:function(){
    ...
    <script type="text/javascript">
        function remove_from_cart($id) {
            ...
            $.ajax({
                type:'get',
                url:'{{ route('delete_cart_list_for_sale') }}',
                data:{'id':product_id},
                success:function(product){
                    window.setTimeout(function () {
                        window.location.href = "{{ route('sales-create-page') }}";
