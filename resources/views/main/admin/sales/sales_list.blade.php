...
@endphp
    ...
    <h1>@if ( Auth::User()->language == 1 ) সেলস লিস্ট @else Sales List @endif</h1>
        <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) সেলস লিস্ট @else Sales List @endif</a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <h3 class="box-title">@if ( Auth::User()->language == 1 ) সেলস রেকর্ড @else Sales Record @endif</h3>
        </div>
        <div class="box-body">
                    @if ($errors->any())
        ...
        <tr>
            ...
            <td nowrap="">
                ...
                <a class="btn btn-flat bg-purple details-invoice" href="{{route('sales-delete-page',$data->sales_invoice)}}"><i class="fa fa-trash cat-child"></i></a>
            </td>
        </tr>
        @endforeach
        </tbody>
        ...
        <a href="{{route('sales-create-page')}}" class="btn btn-flat bg-purple">@if ( Auth::User()->language == 1 ) ক্রিয়েট সেলস @else Create Sales @endif</a>
        </div>
        </div>
        </div>
        </div>
