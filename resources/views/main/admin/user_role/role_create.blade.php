...
@section("content")
    ...
    <section class="content-header">
        <h1>@if ( Auth::User()->language == 1 ) রোল ক্রিয়েট @else Role Create @endif</h1>
        <ol class="breadcrumb">
            <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
            <li class=""><a href="">@if ( Auth::User()->language == 1 ) রোল ক্রিয়েট @else Role Create @endif</a></li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-8">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">@if ( Auth::User()->language == 1 ) এসাইন নিউ রোল @else Assign New Role @endif</h3>
                    </div>
                    <div class="box-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('role-store-page') }}" onsubmit="return validate()" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            @csrf
