                  ...
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <li class="invpiv active" id="pi_64">
                           <p><strong class="pino">{{$data->record_no}}</strong><br><strong class="name">{{$data->item_name}}</strong><br><strong></strong></p>
                           <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>Q: ৳ {{$data->quantity}}</strong><br><strong>P: ৳ @php echo number_format("$data->price",2) @endphp</strong></div>
                        </li>
                        @endforeach
                     </ul>
                     <div class="whole">
                     ...
                     <div class="printableArea">
                        ...
                        <div class="wrapper" style="width: 407.726px; height: 574.703px; overflow: hidden;">
                           <div id="wrap_invoice" class="page A4 portrait" style="transform: scale(0.51); transform-origin: 10px 0px 0px;">
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($data->record_no, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Material N°:</strong> {{$data->record_no}}
                                        <br><strong>Product:</strong>{{$data->item_name}}
                                    </div>
                                 </div>
                                 <hr>
                              ...
                              <center>
                                 <h3 class="page-title">MATERIAL INVOICE</h3>
                              </center>
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                       <thead>
                                          <tr>
                                             ...
                                             <th style="width:12.5% !important;">Cost</th>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td class="text-md-left">{{$data->record_no}}</td>
                                             <td class="text-md-right">{{$data->cost}}</td>
                                             <td class="text-md-center">{{$data->quantity}}</td>
                                          ...
                                          <tr>
                                             ...
                                             <td colspan="2" class="text-md-right font-weight-bold text-nowrap">@php echo number_format("$data->price",2) @endphp</td>
                                          </tr>
                                          @endforeach
                                       </tbody>
                                    </table>
