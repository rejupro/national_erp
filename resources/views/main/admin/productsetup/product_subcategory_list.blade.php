...
<section class="content-header">
   <h1>@if ( Auth::User()->language == 1 ) সাব-ক্যাটেগরি লিস্ট @else Sub-Category List @endif</h1>
   <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) সাব-ক্যাটেগরি লিস্ট @else Sub-Category List @endif</a></li>
   </ol>
</section>
<!-- Main content -->
      ...
      <div class="col-md-8">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title">@if ( Auth::User()->language == 1 ) সাব-ক্যাটেগরি লিস্ট @else Sub-Category List @endif</h3>
            </div>
            <div class="box-body">
               ...
               <div class="row"style="margin-top: 15px" >
                  <div class="col-md-12 table-responsive">
                     ...
                     <div class="col-md-4 text-right" >
                        <a href="{{route('subcategory-create-route')}}" class="btn btn-flat bg-purple">@if ( Auth::User()->language == 1 ) এড সাব-ক্যাটেগরি @else Add Sub-Category @endif</a>
                     </div>
                  </div>
               </div>
            </div>
