...
<section class="content-header">
   <h1>@if ( Auth::User()->language == 1 ) জেলা যুক্তকরন @else Add District @endif</h1>
   <ol class="breadcrumb">
      ...
      <div class="col-md-8">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title">@if ( Auth::User()->language == 1 ) জেলা যুক্তকরন @else Add District @endif</h3>
            </div>
            <div class="box-body">
                ...
                @endif
                  ...
                  <div class="row"style="margin-top: 15px" >
                     ...
                     <div class="col-md-4 text-right" >
                        <input type="submit" name="save_country" id="submit" class="btn btn-flat bg-purple btn-sm " value="@if ( Auth::User()->language == 1 ) সেভ @else Save @endif"/> <a href="{{route('district-list')}}" class="btn btn-flat bg-gray  ">@if ( Auth::User()->language == 1 ) ক্লোজ @else Close @endif</a>
                     </div>
                  </div>
               </form>
            </div>
