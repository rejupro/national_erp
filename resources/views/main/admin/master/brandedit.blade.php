...
@section("content")
    ...
    <h1>@if ( Auth::User()->language == 1 ) ইডিট ব্র্যান্ড @else Edit Brand @endif</h1>
    <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) ইডিট ব্র্যান্ড @else Edit Brand @endif</a></li>
    </ol>
    </section>
<section class="content">
    ...
    <h3 class="box-title">@if ( Auth::User()->language == 1 ) ইডিট ব্র্যান্ড @else Edit Brand @endif</h3>
    </div>
    <div class="box-body">
...
@endif
    ...
    <input type="submit" name="update_brand" id="submit" class="btn btn-flat bg-purple btn-sm " value="@if ( Auth::User()->language == 1 ) আপডেট @else Update @endif"/> <a href="{{route('brand-list')}}" class="btn btn-flat bg-gray  ">@if ( Auth::User()->language == 1 ) ক্লোজ @else Close @endif</a>
    </div>
    </div>
    </form>
    </div>
