...
<section class="content-header">
    <h1>@if ( Auth::User()->language == 1 ) এড ইউনিট  @else Add Unit @endif</h1>
   <ol class="breadcrumb">
      <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
      <li class=""><a href="">@if ( Auth::User()->language == 1 ) এড ইউনিট  @else Add Unit @endif</a></li>
   </ol>
</section>
<!-- Main content -->
<section class="content">
    ...
    <h3 class="box-title">@if ( Auth::User()->language == 1 ) এড ইউনিট  @else Add Unit @endif</h3>
    </div>
    <div class="box-body">
    ...
    <input type="submit" name="save_unit" id="submit" class="btn btn-flat bg-purple btn-sm " value="@if ( Auth::User()->language == 1 ) সেভ @else Save @endif"/> <a href="{{route('unit-list')}}" class="btn btn-flat bg-gray  ">@if ( Auth::User()->language == 1 ) ক্লোজ @else Close @endif</a>
    </div>
    </div>
    </form>
    </div>
