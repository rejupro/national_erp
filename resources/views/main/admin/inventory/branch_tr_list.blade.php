...
<section class="content-header">
   <h1>@if ( Auth::User()->language == 1 ) ব্রাঞ্চ ট্রান্সফার @else Branch Transfer @endif </h1>
   <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) ব্রাঞ্চ ট্রান্সফার @else Branch Transfer @endif</a></li>
   </ol>
</section>
...
<section class="content">
   ...
   <!-- <th style="width:40px; text-align:center;">@if ( Auth::User()->language == 1 ) অ্যাকশন @else Action @endif</th> -->
    ...
    <a href="{{ route('branch-transfer-stock-create') }}" class="btn btn-flat bg-purple">@if ( Auth::User()->language == 1 ) ক্রিয়েট ট্রান্সফার @else Create Transfer @endif</a>
    </div>
    </div>
    </div>
    </div>
