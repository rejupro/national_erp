...
@endphp
    ...
    <h1>@if ( Auth::User()->language == 1 ) ব্রাঞ্চ স্টক @else Branch Stock @endif</h1>
        <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) ব্রাঞ্চ স্টক @else Branch Stock @endif</a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <h3 class="box-title">@if ( Auth::User()->language == 1 ) ব্রাঞ্চ স্টক স্ট্যাটাস @else Branch Stock Status @endif</h3>
        </div>
        <div class="box-body">
