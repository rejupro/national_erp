...
<section class="content-header">
   <h1>@if ( Auth::User()->language == 1 ) ওয়ারহাউজ ট্রান্সফার ক্রিয়েট @else Warehouse Transfer Create @endif</h1>
   <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) ওয়ারহাউজ ট্রান্সফার ক্রিয়েট @else Warehouse Transfer Create @endif</a></li>
   </ol>
</section>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-solid">
                    ...
                    <h3 class="box-title">@if ( Auth::User()->language == 1 ) ওয়ারহাউজ ট্রান্সফার ক্রিয়েট @else Warehouse Transfer Create @endif</h3>
                    </div>
                        @if ($errors->any())
                        ...
                        @endif
                    <div class="box-body">
                        <form action="{{ route('warehouse-transfer-stock-store') }}" onsubmit="return validate()" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
                            @csrf
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                         <div class="form-group" >
                                             <label>@if ( Auth::User()->language == 1 ) ওয়ারহাউজের নাম (হতে) @else Warehouse Name(From) @endif</label>
                                    ...
                                    <div class="row">
                                         <div class="form-group" >
                                             <label>@if ( Auth::User()->language == 1 ) ব্রাঞ্চের নাম (হতে) @else Branch Name(To) @endif</label>
                                             <div class="input-group">
                                                 <span class="input-group-addon">TBN</span>
                            ...
                            <div class="row"style="margin-top: 15px" >
                                ...
                                <input type="submit" name="save_user" id="submit" class="btn btn-flat bg-purple btn-sm " value="@if ( Auth::User()->language == 1 ) সেভ @else Save @endif"/> <a href="{{ route('warehouse-transfer-stock-list') }}" class="btn btn-flat bg-gray  ">@if ( Auth::User()->language == 1 ) ক্লোজ @else Close @endif</a>
                                </div> 
                            </div>     
                        </form>    
                    </div>
...
<script type="text/javascript">
    function find_product() {
        var warehouse_id_from = $('#warehouse_id_from').val();
            ...
            var url = '{{ route("find_product_for_transfer_warehouse", ":slug") }}';
