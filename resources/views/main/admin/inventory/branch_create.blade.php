   ...
   <div class="row">
      <div class="col-md-8">
         <div class="box box-solid">
            ...
            <div class="box-body">
               {{-- Error messages --}}
               <form action="{{route('branch-store-route')}}" onsubmit="return validate()" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                @csrf
                <div class="col-md-12 popup_details_div">
                  ...
                  <div class="row"style="margin-top: 15px" >
                     ...
                     <div class="col-md-4 text-right" >
                        <input type="submit" name="save_branch" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="{{route('branch-list')}}" class="btn btn-flat bg-gray">Close</a>
                     </div>
                  </div>
               </form>
            </div>
