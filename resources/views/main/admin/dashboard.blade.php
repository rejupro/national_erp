                            ...
                            <table id="dash_notifications" class="table notification_table">
                                ...
                                <tbody>
                                    @foreach($message as $data)
                                        <tr>
                                            <td><a href="{{ route('view_full_message',$data->id) }}">{{ $data->name }}</a></td>
                                            <td><a href="{{ route('view_full_message',$data->id) }}">{{ $data->email }}</a></td>
                                            <td><a href="{{ route('view_full_message',$data->id) }}">{{ date('d-m-Y', strtotime($data->created_at)) }}</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    <td colspan="2"></td>
                                    <td><a href="{{ route('contact_message_list') }}" type="button" class="btn btn-flat bg-purple btn-sm"><span>See More..</span></a></td>
                                </tfoot>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-6">
                        ...
                        <a href="">
                            <div class="small-box">
                                ...
                                <div class="inner">
                                    <h3 id="crm-count">{{ count($products) }}</h3>
                                    <p>Products</p>
                                </div>
                    ...
                    <div class="col-md-3 col-xs-6">
                        ...
                        <a href="">
                            <div class="small-box ">
                                    <div class="ribbon"><span>Total</span></div>
                                    <div class="inner">
                                        <h3 id="lead-count">{{ count($projects) }}</h3>
                                        <p>Projects</p>
                                    </div>
                                    <div class="icon">
                    ...
                    <div class="col-md-3 col-xs-6">
                        ...
                        <a href="">
                            ...
                            <div class="small-box ">
                                <div class="ribbon"><span>Total</span></div>
                                <div class="inner">
                                    <h3 id="opportunity-count">{{ count($purchases) }}</h3>
                                    <p>Purchase</p>
                                </div>
                                <div class="icon">
                    ...
                    <div class="col-md-3 col-xs-6">
                        ...
                        <a href="">
                            ...
                            <div class="small-box">
                                ...
                                <div class="inner">
                                    <h3 id="sale-count">{{ count($sales) }}</h3>
                                    <p>Sales</p>
                                </div>
                            </div>
                        </a>
