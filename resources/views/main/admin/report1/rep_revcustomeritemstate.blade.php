...
$menuh='Report';
$phead='report';
$page='Customer Statement (Item)';
$ractive='D';
$print='print';
$dtnow = date("Y-m-d h:i:s", time());
$today = strftime("%Y-%m-%d", time());
$oavno='REP'.date("dmy", strtotime($today)).'REVCSI';
@endphp
<section class="content-header">
  <h1>Customer Statement (Item)</h1>
  <ol class="breadcrumb">
     <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
     <li><a href="mas_brandcreate.php">Report</a></li>
     <li class=""><a href="#">Customer Statement (Item)</a></li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
    ...
    <center>
    <h3 class="page-title">Customer Statement (Item)</h3>
    </center>    
