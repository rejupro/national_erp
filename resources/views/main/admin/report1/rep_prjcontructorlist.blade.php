...
$menuh='Report';
$phead='report';
$page='Contructor List';
$ractive='C';
$print='print';
$dtnow = date("Y-m-d h:i:s", time());
$today = strftime("%Y-%m-%d", time());
$oavno='REP'.date("dmy", strtotime($today)).'PRJCL';
@endphp
<section class="content-header">
  <h1>Contructor List</h1>
  <ol class="breadcrumb">
     <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
     <li><a href="mas_brandcreate.php">Report</a></li>
     <li class=""><a href="#">Contructor List</a></li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
    ...
    <li  @if($ractive=='C') class="active" @endif><a href="{{route('project-contractorlist-report')}}">Contructor List</a></li>
    <li  @if($ractive=='D') class="active" @endif><a href="{{route('project-contractorbalance-report')}}">Contructor Balance</a></li>
    <li  @if($ractive=='E') class="active" @endif><a href="{{route('project-contractorstate-report')}}">Contructor Statement</a></li>
    ...
    <center>
    <h3 class="page-title">Contructor List</h3>
    </center>    
