               ...
               <div class="col-md-3">
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="{{route('requisition-view-route',['id'=>$lists->id])}}">
                              ...
                              <div class="etat_content">
                                 <div class="page_split">
                                    ...
                                    <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Project Name</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;">{{$requisition->project->name}}</span></p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Status</h4>
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td class="text-md-right">{{$data->nprice}}</td>
                                         ...
                                         <tr>
                                            ...
                                            <td colspan="2" class="text-md-right font-weight-bold text-nowrap">{{$requisition->grand_total}}</td>
                                         </tr>
