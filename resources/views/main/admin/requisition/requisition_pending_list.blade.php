...
<section class="content-header">
   <h1>@if ( Auth::User()->language == 1 ) পেন্ডিং রিকুইজিশন রেকর্ড @else Pending Requisition Record @endif</h1>
   <ol class="breadcrumb">
      <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
      <li class=""><a href="">@if ( Auth::User()->language == 1 ) পেন্ডিং রিকুইজিশন রেকর্ড @else Pending Requisition Record @endif</a></li>
   </ol>
</section>
<!-- Main content -->
      ...
      <div class="col-md-12">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title">@if ( Auth::User()->language == 1 ) পেন্ডিং রিকুইজিশন লিস্ট @else Pending Requisition List  @endif</h3>
            </div>
            <div class="box-body">
                @if ($errors->any())
                  ...
                  <table class="table table-bordered table-striped" id="datarec">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td width="65px"> <a href="{{route('requisition-statusapprove-route',$data->id)}}" class="btn btn-flat bg-purple">Approve</a><a href="{{route('requisition-statuscancel-route',$data->id)}}" class="btn btn-flat bg-red">Cancel</a></td>
                           <td width="60px">
