...
@section("content")
    ...
    <section class="content-header">
        <h1>@if ( Auth::User()->language == 1 ) রিকুইজিশন ক্রিয়েট @else Requisition Create @endif</h1>
        <ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) রিকুইজিশন ক্রিয়েট @else Requisition Create @endif</a></li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">@if ( Auth::User()->language == 1 ) এড নিউ রিকুইজিশন @else Add New Requisition @endif</h3>
                    </div>
                    <div class="box-body">
                    </div id="result">
                    </div>
                        <form id="dynamic_form" action="{{route('requisition-store-route')}}"  enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            ...
                            <div class="row"style="margin-top: 15px" >
                                ...
                                <div class="col-md-4 text-right" >
                                    <input type="submit" name="save" id="save" class="btn btn-flat bg-purple btn-sm" value="@if ( Auth::User()->language == 1 ) সেভ @else Save @endif"/> <a href="{{route('requisition-list-route')}}" class="btn btn-flat bg-gray">@if ( Auth::User()->language == 1 ) ক্লোজ @else Close @endif</a>
                                </div>
                            </div>
                        </form>
                    </div>
