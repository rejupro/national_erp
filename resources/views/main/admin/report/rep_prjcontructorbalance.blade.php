...
$menuh='Report';
$phead='report';
$page='Contructor Balance';
$ractive='D';
$print='print';
$dtnow = date("Y-m-d h:i:s", time());
$today = strftime("%Y-%m-%d", time());
$oavno='REP'.date("dmy", strtotime($today)).'PRJCB';
@endphp
<section class="content-header">
  <h1>Contractor Balance</h1>
  <ol class="breadcrumb">
   <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
   <li><a href="mas_brandcreate.php">Report</a></li>
   <li class=""><a href="#">Contractor Balance</a></li>
 </ol>
</section>
<!-- Main content -->
            ...
            <div class="printableArea">    
             ...
             <div class="wrapper" style="background: none;">    
              <div id="wrap_invoice" class="page A4 landscape">
                ...
                <center>
                  <h3 class="page-title">Contructor Balance</h3>
                </center>    
                  ...
                  <div class="page_split">    
                    ...
                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="7" class="text-md-center"><strong>Note: <span style="color: red;">Pay To Contructor:   ||  Get From Contructor: </span></strong></td>    
                        </tr>    
                      </tbody>
                    </table> 
