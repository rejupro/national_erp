            ...
            <div class="col-md-12">    
              <div class="row">    
                <div class="roles-menu">   
                  <ul class="nav">
                    <li  @if($ractive=='A') class="active" @endif><a href="{{route('project-list-report')}}">Project Status</a></li>
                    <li  @if($ractive=='B') class="active" @endif><a href="{{route('project-details-report')}}">Project Details</a></li>
                    <li  @if($ractive=='C') class="active" @endif><a href="{{route('project-contructorlist-report')}}">Contractor List</a></li>
                    <li  @if($ractive=='D') class="active" @endif><a href="{{route('project-contructorbalance-report')}}">Contractor Balance</a></li>
                    <li  @if($ractive=='E') class="active" @endif><a href="{{route('project-contructorstate-report')}}">Contractor Statement</a></li>
        ...
        <div class="row">
          <div class="invhold scrol-y" id="invhold">
            <div class="printableArea">    
             @include('main.admin.report.reportstylestate')
             ...
             <div class="pcs-template ">
              ...
              <div class="pcs-template-body">
                <table style="line-height:18px;" cellpadding="0" cellspacing="0" border="0" width="100%">
                  <tbody><tr>
                    <td>
                      <img src="{{asset(companyData()->image)}}" style="width:100.00px;height:87.00px;" id="logo_content">
                    </td>

                    <td width="50%" class="pcs-orgname text-align-right">
                      <b>{{ companyData()->name }}</b><br>
                      <span style="white-space: pre-wrap;" id="tmp_org_address"><p>{{ companyData()->address }}<br><strong>Phone:</strong>{{ companyData()->phone }}<br><strong>Mobile:</strong> {{ companyData()->mobile }}<br><strong>Email:</strong> {{ companyData()->email }}<br><strong>Web:</strong>  {{ companyData()->web }}</p></span>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <table cellpadding="0" cellspacing="0" border="0" class="title-section">
                        ...
                        <tr>
                          <td style="font-size:12px; border-top: 1px solid #000;border-bottom: 1px solid #000;" height="24" class="text-align-right">{{ $today ."To". $today}}</td>
                        </tr>
                      </tbody></table>
                    </td>
                  </tr>
