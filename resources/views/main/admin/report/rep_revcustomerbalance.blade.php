...
$oavno='REP'.date("dmy", strtotime($today)).'REVCB';
@endphp
<section class="content-header">
  ...
  <ol class="breadcrumb">
   ...
   <li class=""><a href="#">Customer Balance</a></li>
 </ol>
</section>
<!-- Main content -->
                  ...
                  <div class="page_split">    
                    ...
                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="7" class="text-md-center"><strong>Note: <span style="color: red;">Pay To Customer:   ||  Get From Customer: </span></strong></td>    
                        </tr>       
