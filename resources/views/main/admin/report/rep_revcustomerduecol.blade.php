...
$menuh='Report';
$phead='report';
$page='Customer Due Collection';
$ractive='E';
$print='print';
$dtnow = date("Y-m-d h:i:s", time());
$today = strftime("%Y-%m-%d", time());
$oavno='REP'.date("dmy", strtotime($today)).'REVCDC';
@endphp
<section class="content-header">
  <h1>Customer Due Collection</h1>
  <ol class="breadcrumb">
   <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
   <li><a href="mas_brandcreate.php">Report</a></li>
   <li class=""><a href="#">Customer Due Collection</a></li>
</ol>
</section>
<!-- Main content -->
                        ...
                        <div class="col-md-12">    
                            <div class="row">    
                                <div class="roles-menu">   
                                    <ul class="nav">
                                        <li  @if($ractive=='A') class="active" @endif><a href="{{route('customerlist-report')}}">Customer List</a></li>
                                        <li  @if($ractive=='B') class="active" @endif><a href="{{route('customerbalance-report')}}">Customer Balance</a></li>
                                        <li  @if($ractive=='C') class="active" @endif><a href="{{route('customerstatement-report')}}">Customer Statement</a></li>
                                        <li  @if($ractive=='D') class="active" @endif><a href="{{route('customeritemstate-report')}}">Customer Item Statement</a></li>
                                        <li  @if($ractive=='E') class="active" @endif><a href="{{route('customerduecol-report')}}">Customer Due Collection</a></li>
                                        <li  @if($ractive=='F') class="active" @endif><a href="{{route('customeroverview-report')}}">Customer Overview</a></li>`
                                        <li  @if($ractive=='G') class="active" @endif><a href="{{route('revoverview-report')}}">Overview</a></li>
                                    </ul>
                                </div>
                            </div>
                            <hr>    
        ...
        <div class="row">
            <div class="invhold scrol-y" id="invhold">
                <div class="printableArea">    
                  ...
                  <center>
                    <h3 class="page-title">Customer Due Collection</h3>
                </center>    
                  ...
                  <div class="page_split">
                      ...
                      <div class="row row-equal">
                          <div class="col-xs-4 text-left">
                              <h3 class="inv col"><b>District: </b>Kishoregonj</h3>
                          </div>
                          <div class="col-xs-4 text-center">
                              <h3 class="inv col"><b>Branch: Main Branch</b></h3>        
                          </div>    
                          <div class="col-xs-4 text-right">
                              <h3 class="inv col"><b>Zone: </b>Dhaka</h3>
                          </div>
                      </div>    
                      <hr>    
                      <br>
                      <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                          <thead>
                              <tr>
                                  ...
                                  <th style="width:100px;"><strong>Collected</strong></th>    
                              </tr>    
                          </thead>
                          <tbody>   
                              <tr>
