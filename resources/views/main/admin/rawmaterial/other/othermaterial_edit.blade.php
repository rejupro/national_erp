...
@endphp
    ...
    <section class="content-header">
	    <h1>@if ( Auth::User()->language == 1 ) অন্যান্য ম্যাটেরিয়াল ইডিট @else Ohter Material Edit @endif</h1>
	    <ol class="breadcrumb">
	        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
	        <li class=""><a href="">@if ( Auth::User()->language == 1 ) অন্যান্য ম্যাটেরিয়াল ইডিট @else Ohter Material Edit @endif</a></li>
	     </ol>
    </section>
    <!-- Main content -->
	       ...
	       <div class="col-md-10">
	          <div class="box box-solid">
	             ...
	             <div class="box-body">
	               ...
	               @endif
				   <form action="{{route('other_rawmaterialupdate', $data->id)}}" method="post" enctype="multipart/form-data">
					@csrf
				    <div class="row ">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="number" name="price" maxlength="35" value="{{ $data->price }}" id="name" class="@error('name') is-invalid @enderror form-control" placeholder="Price">
							</div>
							<div class="form-group">
								...
								@else
								<img id="blah" src="{{asset('public/Upload/rawmaterial/no_image.jpg')}}" style="max-height: 100px; max-width: 100px">
								@endif
							</div>
							<div class="form-group">
