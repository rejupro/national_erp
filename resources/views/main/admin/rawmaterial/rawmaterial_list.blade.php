	                   ...
	                   <table class="table table-bordered table-striped" id="datarec">
	                      ...
	                      <tbody>
								...
								<tr>
									...
									<td>{{$data->code}}</td>
									<td>{{$data->name}}</td>
									<td><img src="{{asset('public/' . $data->image)}}" alt="" style="max-height: 100px; max-width: 100px"></td>
									<td>
									<a class="btn btn-flat bg-purple" href="{{ route('materialedit', ['id' => $data->id]) }}" ><i class="fa fa-edit"></i></a>
									<a class="btn btn-flat bg-purple" onclick="return confirm('Are you sure you want to delete this item?');" href="{{route('materialdelete',['id' => $data->id]) }}"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								@endforeach
	                      </tbody>
