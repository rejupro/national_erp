                                ...
                                <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tbody id="tradata">
                                       ...
                                       @foreach ($salesdetails as $datas2)
                                        <tr>
                                            <td style="width:40px;" class="center">{{$i++}}</td>
                                            <td style="text-align:left; width:100px;">{{date('d-m-Y', strtotime($datas2->purchase_date))}}</td>
                                            <td style="text-align:left; width:90px;"><a class="btn btn-flat bg-purple" href="{{route('purchese-view-page',['id' => $datas2->id])}}">{{$datas2->pur_invoice}}</a></td>
