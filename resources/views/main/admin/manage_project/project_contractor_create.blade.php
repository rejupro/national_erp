...
@endphp
    <section class="content-header">
        <h1>@if ( Auth::User()->language == 1 ) কন্ট্রাকটর ক্রিয়েট @else Contractor Create @endif</h1>
        <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i>@if ( Auth::User()->language == 1 ) ড্যাসবোর্ড @else Dashboard @endif</a></li>
        <li class=""><a href="">@if ( Auth::User()->language == 1 ) কন্ট্রাকটর ক্রিয়েট @else Contractor Create @endif</a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <h3 class="box-title">@if ( Auth::User()->language == 1 ) কন্ট্রাকটর ক্রিয়েট @else Contractor Create @endif</h3>
        </div>
        <div class="box-body">
            @if ($errors->any())
            ...
            @endif
        <form action="{{route('project-contractor-store-page')}}" onsubmit="return validate()" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            @csrf
            <div class="col-md-12 popup_details_div">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" maxlength="15" value="{{$results}}" readonly="readonly" id="code" class="form-control" placeholder="e.g. ABA/CO/001" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="row"style="margin-top: 15px" >
                    ...
                    <div class="col-md-4 text-right" >
                        <input type="submit" name="save_contractor" id="submit" class="btn btn-flat bg-purple btn-sm" value="@if ( Auth::User()->language == 1 ) সেভ @else Save @endif"/> <a href="{{route('project-contractor-list-page')}}" class="btn btn-flat bg-gray">@if ( Auth::User()->language == 1 ) ক্লোজ @else Close @endif</a>
                    </div>
                </div>
        </form>
        </div>
