                  ...
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <li class="invpiv active" id="pi_64">
                           <p><strong class="pino">{{$lc->lc_no}}</strong><br><strong class="name">{{$lc->s_name}}</strong><br><strong></strong></p>
                           <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>
                               T: ৳ @php echo number_format("$lc->t_amount",2) @endphp</strong><br><strong>Date: {{$lc->ship_date}}</strong></div>
                        </li>
                      ...
                      @include('layouts.admin.print_head2')
                        <div class="wrapper" style="width: 407.726px; height: 574.703px; overflow: hidden;">
                           <div id="wrap_invoice" class="page A4 portrait" style="transform: scale(0.51); transform-origin: 10px 0px 0px;">
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($lc->ship_date, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Transaction N°:</strong> {{$lc->pi_code}}
                                        <br><strong>Supplier Name:</strong> {{$lc->s_name}}
                                     </div>
                                 </div>
                                 <hr>
                              ...
                              <center>
                                 <h3 class="page-title">LC INVOICE</h3>
                              </center>
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                       <thead>
                                          <tr>
                                             ...
                                             <th style="width:12.5% !important;">Lc No</th>
                                             <th style="width:10% !important;">Buyer </th>
                                             <th style="width:7.5% !important;"> Supplier</th>
                                       ...
                                       <tbody>
                                        ...
                                        @endphp
                                          ...
                                          <tr>
                                             ...
                                             <td class="text-md-left">{{$lc->pi_code}}</td>
                                             <td class="text-md-right">{{$lc->lc_no}}</td>
                                             <td class="text-md-center">{{$lc->b_name}}</td>
                                             <td class="text-md-center">{{$lc->s_name}}</td>
                                             <td class="text-md-right">@php echo number_format("$lc->t_amount",2) @endphp</td>
                                          </tr>
                                          ...
                                          <tr>
                                             ...
                                             <td colspan="2" class="text-md-right font-weight-bold text-nowrap">@php echo number_format("$lc->t_amount",2) @endphp</td>
                                          </tr>
                                          <p>
                                            <b>Amount in words:
                                            </b>
                                            <span style="text-transform: uppercase;">
                                            {{NumConvert::word($lc->t_amount)}}
                                            <b>Taka</b> Only.</span>
                                         </p>
