    ...
    <section class="content">
        ...
        <div class="col-md-12 popup_details_div">
            ...
            <div class="row"style="margin-top: 15px" >
                ...
                <input type="submit" name="save_subgroup" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="{{route('prosubgroup-list-create')}}" class="btn btn-flat bg-gray  ">Close</a>
                </div>
            </div>
        </form>
        </div>
