...
@endphp
    ...
    <!-- Main content -->
        <section class="content">
            ...
            <input type="submit" name="save_group" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="{{route('progroup-list-create')}}" class="btn btn-flat bg-gray  ">Close</a>
            </div>
            </div>
            </form>
            </div>
