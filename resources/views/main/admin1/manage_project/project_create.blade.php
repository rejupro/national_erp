...
@endphp
    <section class="content-header">
     ...
     <section class="content">
        ...
        <input type="submit" name="save_project" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="{{route('project-list-page')}}" class="btn btn-flat bg-gray  ">Close</a>
        </div>
        </div>
        </form>
        </div>
