                              ...
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($projects->project_id, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Transaction N°:</strong> {{$projects->project_id}}
                                        <br><strong>Department/Client Name:{{$projects->customer->name}}</strong> 
                                     </div>
                                 </div>
                                 <hr>
