    ...
    $(document).ready(function(){
     ...
     function dynamic_field(number)
     {
      ...
      html = '<tr>';
            ...
            html += '<th style="width:200px;"><select  class="form-control select2" name="payment_to[]" id="pay_to" required><option selected value="">-Select-</option><optgroup label="Loan Invoice">@foreach($loaninvoice as $data)<option style="background-color:ash;" value="{{$data->inv_no}}">{{$data->inv_no}}-{{$data->total}}</option>@endforeach</optgroup></select></th>';
