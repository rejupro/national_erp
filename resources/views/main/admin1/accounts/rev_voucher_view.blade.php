               ...
               <div class="col-md-3">
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="{{route('receivevoucher-view-route',['id'=>$lists->voucher_no])}}">
                              ...
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                       <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($data->voucher_no, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Receipt N°:</strong> {{$data->voucher_no}}
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($details as $detail)
                                                    <tr>
                                                        ...
                                                        <td class="text-md-left">{{$detail->receive_from}}</td>
                                                        <td class="text-md-left">@if($detail->receive_to=="LE_5") Cash @else Bank @endif</td>
