                  ...
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <li class="invpiv active" id="pi_64">
                           <p><strong class="pino">{{$journal->journal_no}}</strong><br><strong class="name">{{date('d-m-Y', strtotime($journal->date))}}</strong><br><strong></strong></p>
                           <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>A: ৳ @php echo number_format("$data->debit_amount",2) @endphp</strong></div>
                        </li>
                        @endforeach
                     </ul>
                     <div class="whole">
                     ...
                     <div class="printableArea">
                        ...
                        <div class="wrapper" style="width: 407.726px; height: 574.703px; overflow: hidden;">
                           <div id="wrap_invoice" class="page A4 portrait" style="transform: scale(0.51); transform-origin: 10px 0px 0px;">
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($journal->journal_no, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Receipt N°:</strong> {{$journal->journal_no}}
                                        <br><strong>Date:</strong>{{$journal->date}}
                                    </div>
                                 </div>
                                 <hr>
                              ...
                              <center>
                                 <h3 class="page-title">Journal INVOICE</h3>
                              </center>
                                 ...
                                 <div class="page_split">
                                    ...
                                    <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Vendor</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;">{{$journal->projects->name}}</span><br><strong>Contact:</strong> {{$journal->projects->cnumber}}<br><strong>Client ID:</strong> ABA/SU/242</p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Address</h4>
                                          {{$journal->projects->address}}
                                       </div>
                                       <div class="clearfix"></div>
                                    </div>
                                    <br>
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                       <thead>
                                          <tr>
                                             ...
                                             <th style="width:52.5% !important;">Project Name</th>
                                             <th style="width:12.5% !important;">status</th>
                                             <th style="width:10% !important;">Amount</th>
                                             <th style="width:7.5% !important;">Jour No</th>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td class="text-md-center">{{$journal->projects->name}}</td>
                                             <td class="text-md-right">{{$journal->projects->status}}</td>
                                             <td class="text-md-center"><span>৳ </span>@php echo number_format("$data->debit_amount",2) @endphp</td>
                                             <td class="text-md-center">{{$journal->journal_no}}</td>
                                             <td class="text-md-right"><span>৳ </span>@php echo number_format("$journal->total",2) @endphp</td>
                                          </tr>
                                          <tr></tr>
                                          {{-- <tr>
                                             <td colspan="2"></td>
                                          ...
                                          {{-- <tr>
                                             <td colspan="2"></td>
                                             <td colspan="2" class="text-md-left font-weight-bold">Narration</td>
                                             <td colspan="2" class="text-md-right font-weight-bold text-nowrap">{{$journal->narration}}</td>
                                          </tr> --}}
                                          @endforeach
                                       </tbody>
                                    </table>
                                    ...
                                    <p>
                                       ...
                                       <span style="text-transform: uppercase;">
                                        {{NumConvert::word($data->debit_amount)}}
                                       <b>Taka</b> Only.</span>
                                    </p>
                                    <p>
                                    </p>
