                  ...
                  <table class="table table-bordered table-striped" id="datarec">
                     ...
                     <tbody>
                           ...
                           <td nowrap="">
                              ...
                              </a> <a class="btn btn-flat bg-purple" href="{{route('acc-group-destroy-route',['id' => $group->id])}}"><i class="fa fa-trash"></i></a>
                           </td>
                        </tr>
                                @endforeach
                     </tbody>
               ...
               <div class="row"style="margin-top: 15px" >
                  <div class="col-md-12 table-responsive">
                     ...
                     <div class="col-md-4 text-right" >
                        <a href="{{route('acc-group-create-route')}}" class="btn btn-flat bg-purple">Add Group</a>
                     </div>
                  </div>
               </div>
            </div>
