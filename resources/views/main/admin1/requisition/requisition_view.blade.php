               ...
               <div class="col-md-3">
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="{{route('requisition-view-route',['id'=>$lists->code])}}">
                           @if($lists->code==$requisition->code)
                              ...
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($requisition->code, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Requisition N°:</strong> {{$requisition->code}}
                                        <br><strong></strong>
                                    </div>
                                 </div>
                                 <hr>
                                 ...
                                 <div class="page_split">
                                    ...
                                    <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Vendor</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;">{{$requisition->staff->name}}</span><br><strong>Contact:</strong> {{$requisition->cnumber}}<br><strong>Email ID:</strong>{{$requisition->cemail}}</p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Address</h4>
                                          {{$requisition->address}}
                                    ...
                                    <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Project Name</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;">{{$requisition->project->project_id}}</span></p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Status</h4>
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td colspan="2" class="text-md-right font-weight-bold text-nowrap">@php echo number_format("$requisition->grand_total",2) @endphp</td>
                                         </tr>
                                    ...
                                    <p>
                                       ...
                                       <span style="text-transform: uppercase;">
                                        {{NumConvert::word($requisition->grand_total)}} 
                                       <b>Taka</b> Only.</span>
                                    </p>
                                 </div>
                              </div>
