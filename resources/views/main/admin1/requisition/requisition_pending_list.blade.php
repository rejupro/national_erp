...
<section class="content-header">
   <h1>Pending Requisition Record</h1>
   <ol class="breadcrumb">
      <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
      <li><a href="mas_brandcreate.php">Requisition</a></li>
      <li class=""><a href="#">Pending Requisition Record</a></li>
   </ol>
</section>
<!-- Main content -->
      ...
      <div class="col-md-12">
         <div class="box box-solid">
            <div class="box-header with-border">
               <h3 class="box-title">Pending Requisition List</h3>
            </div>
            <div class="box-body">
                @if ($errors->any())
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td width="60px">
                              ...
                              <a class="empty" style="cursor: pointer;" href="{{route('requisition-delete-route',$data->code)}}"><i class="fa fa-trash"></i></a>
