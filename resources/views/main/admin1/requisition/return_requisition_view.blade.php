      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="col-md-1 text-right">
                <a href='{{ url()->previous() }}'><button class="btn btn-flat bg-red" id="closepop"><span><i class="fa fa-times"></i></span></button></a>
            </div>
         </div>
      </div>
   </div>
               ...
               <div class="col-md-3">
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="{{route('returnrequisition-view-route',['id'=>$lists->code])}}">
                           @if($lists->code==$returnrequisition->code)
                           <li class="invpiv active" >
                           @else
                           <li class="invpiv" >
                           @endif
                              <p><strong class="pino">{{$lists->code}}</strong><br><br><strong>{{$lists->created_at}}</strong></p>
                     ...
                     <div class="printableArea">
                        ...
                        <div class="wrapper" style="width: 407.726px; height: 574.703px; overflow: hidden;">
                           <div id="wrap_invoice" class="page A4 portrait" style="transform: scale(0.51); transform-origin: 10px 0px 0px;">
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($returnrequisition->code, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Return Requisition N°:</strong> {{$returnrequisition->code}}
                                        <br><strong></strong>
                                    </div>
                                 </div>
                                 <hr>
                              ...
                              <center>
                                 <h3 class="page-title">RETURN REQUISITION INVOICE</h3>
                              </center>
                                 ...
                                 <div class="page_split">
                                    ...
                                    <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Vendor</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;">{{$returnrequisition->staff->name}}</span><br><strong>Contact:</strong> {{$returnrequisition->cnumber}}<br><strong>Email ID:</strong>{{$returnrequisition->cemail}}</p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Address</h4>
                                          {{$returnrequisition->address}}
                                       </div>
                                    ...
                                    <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Project Name</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;">{{$returnrequisition->project->project_id}}</span></p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Requisition Code</h4>
                                          <p><strong>{{$returnrequisition->requisition_id}}</strong></p>
                                       </div>
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td class="text-md-center">{{$data->requisition_item}}</td>
                                            <td class="text-md-right">@php echo number_format("$data->nprice",2) @endphp</td>
                                            <td class="text-md-center">{{$data->qty}}</td>
                                            <td class="text-md-center">@php echo number_format("$data->price",2) @endphp</td>
                                         </tr>
                                         @endforeach
                                         <tr>
                                            <td colspan="2"></td>
                                            <td colspan="2" class="text-md-right font-weight-bold"> Total</td>
                                            <td colspan="2" class="text-md-right font-weight-bold text-nowrap">@php echo number_format("$returnrequisition->grand_total",2) @endphp</td>
                                         </tr>
                                    ...
                                    <p>
                                       ...
                                       <span style="text-transform: uppercase;">
                                        {{NumConvert::word($returnrequisition->grand_total)}} 
                                       <b>Taka</b> Only.</span>
                                    </p>
                                 </div>
                              </div>
