...
<section class="content-header">
  <h1>Contructor Statement</h1>
  <ol class="breadcrumb">
     <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
     <li><a href="mas_brandcreate.php">Report</a></li>
     <li class=""><a href="#">Contructor Statement</a></li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
    ...
    <li  @if($ractive=='C') class="active" @endif><a href="{{route('project-contructorlist-report')}}">Contructor List</a></li>
    <li  @if($ractive=='D') class="active" @endif><a href="{{route('project-contructorbalance-report')}}">Contructor Balance</a></li>
    <li  @if($ractive=='E') class="active" @endif><a href="{{route('project-contructorstate-report')}}">Contructor Statement</a></li>
