                        ...
                        <div class="row" id="itemdata">
                            ...
                            <table class="table table-bordered   table-hover">
                                <tbody>
                                    ...
                                    @foreach($expense as $v_liability)
                                    @if($k==0)
                                    @php $k = $k+1; @endphp
                                    <tr>
                            ...
                            <table class="table table-bordered   table-hover">
                                <tbody>
                                    <tr class="bg-gray">
                                        ...
                                        <td width="16.16%" style="text-align: right; border-top: 1px double #000000; border-bottom: 4px double #000000;"><b>{{ $debit + $debit1 }}</b>
                                        </td>
                                        <td width="16.16%" style="text-align: right; border-top: 1px double #000000; border-bottom: 4px double #000000;"><b>{{ ($debit + $debit1) - ($credit + $credit1) }}</b>
                                        </td>
                                        <td width="16.16%" style="text-align: right; border-top: 1px double #000000; border-bottom: 4px double #000000;"><b>{{ $credit + $credit1 }}</b>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
