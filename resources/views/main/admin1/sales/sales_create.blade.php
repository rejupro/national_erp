...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('sales-list-page') }}">Sales</a></li>
                                    ...
                                    <table class="table table-bordered table-striped" style="margin-bottom: 0;">     
                                        <tbody id="itemdata">
                                            ...
                                            <tr>
                                                ...
                                                <td width="60px">
                                                    <input type="text" min="1" onchange="product_sub_total_with_quantity({{ $id=$i }})" class="form-control quantity" id="quantity{{ $i }}" name="quantity[]" value="1" size="2" style="height: 24px;">
                                                </td>
                                                <td width="60px">
                                                    ...
                                                    <div class="accordian-body" id="pitem{{ $i }}">
                                                        <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disp" id="pur_discount{{ $i }}" name="pur_discount[]" value="0" onchange="product_sub_total_with_quantity({{ $id=$i }})" size="2" style="height: 24px;" readonly="readonly">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" min="0" class="form-control disf" id="pur_discount_amount{{ $i }}"  name="pur_discount_amount[]" value="0" onchange="product_sub_total_with_quantity({{ $id=$i }})" readonly="readonly" size="2" style="height: 24px;">
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" min="0" id="sal_discount{{ $i }}" class="form-control sdisp" name="sal_discount[]" value="0" onchange="product_sub_total_with_quantity({{ $id=$i }})" size="2" style="height: 24px;">
                                                                    </td>
                                                                    <td>
    ...
    <script type="text/javascript">
        function product_sub_total_with_quantity($id){
            ...
            if(sal_discount>0){
                ...
                var set_discount_amount = (parseInt(sal_discount)/100) * parseInt(set_price);
                ...
                var set_price = (parseInt(quantity) * parseInt(cost));
                var total_amount = $('#total_amount').val();
                var set_discount = (parseInt(sal_discount_amount)/parseInt(cost)) * 100 ;
                $('#sal_discount' +set_id+ "").val(set_discount);
                var set_sub_total = parseInt(set_price) - parseInt(sal_discount_amount);
                var full_total = $('#total_prchase').val();
                    if(full_total == 0){
                        $('#total_prchase').val(set_sub_total);
                        $('#total_amount').val(set_sub_total);
