                     ...
                     <ul class="list" id="listitem">
                      @foreach ($details as $data)
                        <li class="invpiv active" id="pi_64">
                           <p><strong class="pino">{{$data->sale_track}}</strong><br><strong class="name">{{$data->company_name}}</strong><br><strong>{{$sales->sales_date}}</strong></p>
                           <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>P: ৳ @php echo number_format("$sales->paid",2) @endphp</strong><br><strong>D: ৳ @php echo number_format("$sales->balance",2) @endphp</strong></div>
                        </li>
                        @endforeach
                     <div class="whole">
                        <span>
                               ...
                               <div class="invoice_header etat_header">
                                  <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($data->sale_track, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Transaction N°:</strong> {{$data->sale_track}}
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td class="text-md-left">{{$data->sale_track}}</td>
