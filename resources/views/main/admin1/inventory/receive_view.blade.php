                  ...
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <li class="invpiv active" id="pi_64">
                           <p><strong class="pino">{{$data->purchase_track}}</strong><br><strong class="name">{{$data->item_name}}</strong><br><strong></strong></p>
                           <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>Q: ৳ @php echo number_format("$data->quantity",2) @endphp</strong><br><strong>T: ৳ @php echo number_format("$data->total",2) @endphp</strong></div>
                        </li>
                        @endforeach
                     </ul>
                     <div class="whole">
                              ...
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($data->purchase_track, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Receive N°:</strong> {{$data->purchase_track}}
                                        <br><strong>Supplier Name:</strong> {{$data->supplier_name}}
                                     </div>
                                 </div>
                                 <hr>
                                 ...
                                 <div class="page_split">
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td class="text-md-left">{{$data->purchase_track}}</td>
                                             <td class="text-md-right">@php echo number_format("$data->price",2) @endphp</td>
                                             <td class="text-md-center">@php echo number_format("$data->quantity",2) @endphp</td>
                                             <td class="text-md-center">@php echo number_format("$data->discount",2) @endphp</td>
                                             <td class="text-md-right">@php echo number_format("$data->total",2) @endphp</td>
                                          </tr>

                                          <tr>
                                             <td colspan="2"></td>
                                             <td colspan="2" class="text-md-right font-weight-bold">Discount Amount</td>
                                             <td colspan="2" class="text-md-right font-weight-bold text-nowrap">@php echo number_format("$data->discount_amount",2) @endphp</td>
                                          </tr>
                                          <tr>
                                             <td colspan="2"></td>
                                    ...
                                    <p>
                                       ...
                                       <span style="text-transform: uppercase;">
                                        {{NumConvert::word($data->grand_total)}}
                                       <b>Taka</b> Only.</span>
                                    </p>
                                    <p>
                                    </p>
