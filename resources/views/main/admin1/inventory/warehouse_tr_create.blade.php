                    ...
                    <div class="box-body">
                        <form action="{{ route('warehouse-transfer-stock-store') }}" onsubmit="return validate()" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
                            ...
                            <div class="row"style="margin-top: 15px" >
                                ...
                                <input type="submit" name="save_user" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="{{ route('warehouse-transfer-stock-list') }}" class="btn btn-flat bg-gray  ">Close</a>
                                </div> 
                            </div>     
                        </form>    
                    </div>
