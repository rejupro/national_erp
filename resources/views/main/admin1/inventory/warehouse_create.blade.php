      ...
      <div class="col-md-8">
         <div class="box box-solid">
            ...
            <div class="box-body">
                    ...
                    @endif
               {{-- Error message show --}}
               <form action="{{route('warehouse-store-route')}}" onsubmit="return validate()" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                @csrf
                <div class="col-md-12 popup_details_div">
                  ...
                  <div class="row"style="margin-top: 15px" >
                     ...
                     <div class="col-md-4 text-right" >
                        <input type="submit" name="save_whouse" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="{{route('warehouse-list')}}" class="btn btn-flat bg-gray">Close</a>
                     </div>
                  </div>
               </form>
            </div>
