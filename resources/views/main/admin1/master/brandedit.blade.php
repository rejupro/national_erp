...
@endif
    ...
    <input type="submit" name="update_brand" id="submit" class="btn btn-flat bg-purple btn-sm " value="Update"/> <a href="{{route('brand-list')}}" class="btn btn-flat bg-gray  ">Close</a>
    </div>
    </div>
    </form>
    </div>
