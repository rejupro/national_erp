                ...
                @endif
                  ...
                  <div class="row"style="margin-top: 15px" >
                     ...
                     <div class="col-md-4 text-right" >
                        <input type="submit" name="save_country" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="{{route('zone-list')}}" class="btn btn-flat bg-gray  ">Close</a>
                     </div>
                  </div>
               </form>
            </div>
