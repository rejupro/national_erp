                  ...
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="">
                           ...
                           <li class="invpiv" >
                           {{-- @endif --}}
                              <p><strong class="pino">{{$expense->project->project_id}}</strong><br><br><strong>{{date('d-m-Y', strtotime($expense->date))}}</strong></p>
                              <div class="sname" style="margin-top: -52px;float: right; position: relative;top: 6px;"><strong>T: ৳ @php echo number_format("$expense->grand_total",2) @endphp</strong></div>
                           </li>
                        </a>
                        @endforeach
                     </ul>
                              ...
                              <div class="invoice_header etat_header">
                                 <div class="row model1">
                                    ...
                                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                                       <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($expense->project->project_id, 'C39')}}" alt="barcode" style="margin-right: -10px;padding-bottom: 5px;"><br><strong>Item :</strong> {{$expense->product->name}}
                                       <br><strong>Date:</strong>{{date('d-m-Y', strtotime($expense->date))}}
                                    </div>
                                 </div>
                                 <hr>
                                 ...
                                 <div class="page_split">
                                    ...
                                    {{-- <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Vendor</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;">op</span><br><strong>Contact:</strong>uuu<br><strong>Email ID:</strong>iiiiii</p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Address</h4>
                                        ooooooooo
                                    ...
                                    {{-- <div class="row-cols row">
                                       <div class="col-6 col-xs-6">
                                          <h4>Project Name</h4>
                                          <p><span style="font-size: 15px;font-weight: bold;">jkjkjk</span></p>
                                       </div>
                                       <div class="col-6 col-xs-6">
                                          <h4>Status</h4>
                                          <p><strong>uiuiui</strong></p>
                                       </div>
                                    ...
                                    <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td class="text-md-right">{{$data->unit->name}}</td>
                                            <td class="text-md-center">{{$data->nprice}}</td>
                                            <td class="text-md-center">{{$data->qty}}</td>
                                            <td class="text-md-center">{{$data->price}}</td> 
                                         </tr>
                                         @endforeach
                                         <tr>
                                            <td colspan="2"></td>
