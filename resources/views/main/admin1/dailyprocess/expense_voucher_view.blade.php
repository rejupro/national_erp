               ...
               <div class="col-md-3">
                  <div id="test-list" class="notebooks">
                     ...
                     <ul class="list" id="listitem">
                        ...
                        <a href="{{route('expensevoucher-view-route',['id'=>$lists->voucher_no])}}">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($details as $detail)
                                                    <tr>
                                                        ...
                                                        <td class="text-md-center">{{$detail->expense_name}}</td>
                                                        <td class="text-md-center">@if($detail->other_credits=="LE_5") Cash @else Bank @endif</td>
                                                        {{-- <td style="text-align:left;">{{$detail->cheque_no}}</td>
                                                        <td style="text-align:left;">{{$detail->cheque_date}}</td>   --}}
                                                        <td class="text-md-right"><span>৳ </span> @php echo number_format("$detail->amount",2) @endphp </td>
                                                        <td class="text-md-center">{{$detail->ref}}</td>
                                                    </tr>
                                                  @endforeach
                                            </tbody>
                                            <tfoot>
