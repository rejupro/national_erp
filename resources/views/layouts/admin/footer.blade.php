<style>
    ...
    <img src="{{asset('public/frontend/img/user/DV-Lo_1586579338.jpg')}}">
    </div>
    </div>
    ...
    <tbody><tr>
    <td height="10px"><p><img src="{{asset('public/frontend/chat/images/close-icon-white.png')}}" width="30px" style="cursor: pointer"></p></td>
    </tr>
    <tr>
    ...
    @php $comp = DB::table('companys')->orderBy('id','asc')->first(); @endphp
    <footer class="main-footer">
        © 2010 - 2021. <a href="#" target="_blank" style="font-weight: 1000!important;">{{ $comp->name }}</a> - All Rights Reserved.<span class="footright"><i class="fa fa-heart" style="color: red;"></i> Crafted By <a href="https://webase.com.bd" target="__blank">Webase</a></span>
     </footer>
                ...
                <div class="modal-body" style="min-height: 300px;    background: #00a3e3;">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p style="color: #fff;    font-size: 15px;text-align: center">Administration!!! You will be logged out in <span class="logout_interval" style="font-size:25px">15 minutes</span> due to inactivity.<br>If you wish to continue with this session please click on Renew<br><br></p>
    ...
    <script src="{{asset('public/frontend/js/bootstrap-datepicker.js?V=1.0')}}"></script>
    <script src="{{asset('public/frontend/plugins/checkedit/ckeditor.js')}}"></script>
    <script src="{{asset('public/frontend/js/bootbox.min.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/piker/spectrum.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/datatable/jquery.dataTables.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/datatable/dataTables.bootstrap.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/treetable/js/jquery.treetable.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/select/select2.js')}}"></script>
    <script src="{{asset('public/frontend/js/axes.js?V=1.0')}}"></script>
    <script src="{{asset('public/frontend/js/common.js?V=1.0')}}"></script>
    <script src="{{asset('public/frontend/js/jquery.PrintArea.js')}}"></script>
    <script src="{{asset('public/frontend/js/axes-scanner.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/notify/notify.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/list/list.min.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/list/list.pagination.min.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/toastr/toastr.min.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/tinymce/js/tinymce/tinymce.min.js')}}"></script>
    <script src="{{asset('public/frontend/plugins/livevalidation/live_validation.js')}}"></script>
    <script src="{{asset('public/frontend/js/parsley.js')}}"></script>
    ...
    <!-- Media Uploader -->
    <script type="text/javascript" src="{{asset('public/frontend/chat/smiley/js/emojione.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/frontend/chat/smiley/smiley.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/frontend/chat/chatjs/lightbox.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/frontend/chat/chatjs/chat.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/frontend/chat/chatjs/custom.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/frontend/chat/uploader/plupload.full.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/frontend/chat/uploader/jquery.ui.plupload/jquery.ui.plupload.js')}}"></script>
